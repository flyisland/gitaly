...
func (m *prereceiveAPIMock) ObjectPoolMembers(ctx context.Context, diskPaths []string, storage string, upstreamOnly bool) (map[string][]gitlab.ObjectPoolMember, error) {
	return nil, errors.New("unexpected call")
}
