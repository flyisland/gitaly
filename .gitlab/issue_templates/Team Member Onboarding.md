...
- Reading material
  ...
  - [ ] familiarize yourself with the [Merge request workflow](https://docs.gitlab.com/development/contributing/merge_request_workflow/) specific to working _on_ GitLab (the whole page)
