...
func (x *FindTagError) GetError() isFindTagError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *FindTagError) GetTagNotFound() *ReferenceNotFoundError {
	if x != nil {
		if x, ok := x.Error.(*FindTagError_TagNotFound); ok {
...
func (x *UpdateReferencesError) GetError() isUpdateReferencesError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *UpdateReferencesError) GetInvalidFormat() *InvalidRefFormatError {
	if x != nil {
		if x, ok := x.Error.(*UpdateReferencesError_InvalidFormat); ok {
...
func (x *UpdateReferencesError) GetReferencesLocked() *ReferencesLockedError {
	if x != nil {
		if x, ok := x.Error.(*UpdateReferencesError_ReferencesLocked); ok {
...
func (x *UpdateReferencesError) GetReferenceStateMismatch() *ReferenceStateMismatchError {
	if x != nil {
		if x, ok := x.Error.(*UpdateReferencesError_ReferenceStateMismatch); ok {
...
func (x *DeleteRefsError) GetError() isDeleteRefsError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *DeleteRefsError) GetInvalidFormat() *InvalidRefFormatError {
	if x != nil {
		if x, ok := x.Error.(*DeleteRefsError_InvalidFormat); ok {
			return x.InvalidFormat
		}
	}
	return nil
...
func (x *DeleteRefsError) GetReferencesLocked() *ReferencesLockedError {
	if x != nil {
		if x, ok := x.Error.(*DeleteRefsError_ReferencesLocked); ok {
			return x.ReferencesLocked
		}
	}
	return nil
...
func (x *ListRefsRequest) GetPaginationParams() *PaginationParameter {
	if x != nil {
		return x.PaginationParams
	}
	return nil
...
func (x *ListRefsResponse) GetPaginationCursor() *PaginationCursor {
	if x != nil {
...
const file_ref_proto_rawDesc = "" +
	"\n" +
	"\tref.proto\x12\x06gitaly\x1a\ferrors.proto\x1a\n" +
	"lint.proto\x1a\fshared.proto\"u\n" +
	"\x1cFindDefaultBranchNameRequest\x128\n" +
	"\n" +
	...
	"\fUPDATED_DESC\x10\x02\"b\n" +
	"\x19FindLocalBranchesResponse\x125\n" +
	"\x0elocal_branches\x18\x02 \x03(\v2\x0e.gitaly.BranchR\rlocalBranchesJ\x04\b\x01\x10\x02R\bbranches\"\x9c\x01\n" +
	"\x16FindAllBranchesRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x1f\n" +
	"\vmerged_only\x18\x02 \x01(\bR\n" +
	"mergedOnly\x12'\n" +
	"\x0fmerged_branches\x18\x03 \x03(\fR\x0emergedBranches\"\xa6\x01\n" +
	"\x17FindAllBranchesResponse\x12B\n" +
	"\bbranches\x18\x01 \x03(\v2&.gitaly.FindAllBranchesResponse.BranchR\bbranches\x1aG\n" +
	"\x06Branch\x12\x12\n" +
	"\x04name\x18\x01 \x01(\fR\x04name\x12)\n" +
	"\x06target\x18\x02 \x01(\v2\x11.gitaly.GitCommitR\x06target\"e\n" +
	"\x0eFindTagRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x19\n" +
	"\btag_name\x18\x02 \x01(\fR\atagName\"0\n" +
	"\x0fFindTagResponse\x12\x1d\n" +
	"\x03tag\x18\x01 \x01(\v2\v.gitaly.TagR\x03tag\"]\n" +
	"\fFindTagError\x12D\n" +
	"\rtag_not_found\x18\x01 \x01(\v2\x1e.gitaly.ReferenceNotFoundErrorH\x00R\vtagNotFoundB\a\n" +
	"\x05error\"\x87\x03\n" +
	"\x12FindAllTagsRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12:\n" +
	"\asort_by\x18\x02 \x01(\v2!.gitaly.FindAllTagsRequest.SortByR\x06sortBy\x12H\n" +
	"\x11pagination_params\x18\x03 \x01(\v2\x1b.gitaly.PaginationParameterR\x10paginationParams\x1a\xb0\x01\n" +
	"\x06SortBy\x127\n" +
	"\x03key\x18\x01 \x01(\x0e2%.gitaly.FindAllTagsRequest.SortBy.KeyR\x03key\x123\n" +
	"\tdirection\x18\x02 \x01(\x0e2\x15.gitaly.SortDirectionR\tdirection\"8\n" +
	"\x03Key\x12\v\n" +
	"\aREFNAME\x10\x00\x12\x0f\n" +
	"\vCREATORDATE\x10\x01\x12\x13\n" +
	"\x0fVERSION_REFNAME\x10\x02\"6\n" +
	"\x13FindAllTagsResponse\x12\x1f\n" +
	"\x04tags\x18\x01 \x03(\v2\v.gitaly.TagR\x04tags\"^\n" +
	"\x10RefExistsRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x10\n" +
	"\x03ref\x18\x02 \x01(\fR\x03ref\")\n" +
	"\x11RefExistsResponse\x12\x14\n" +
	"\x05value\x18\x01 \x01(\bR\x05value\"a\n" +
	"\x11FindBranchRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x12\n" +
	"\x04name\x18\x02 \x01(\fR\x04name\"<\n" +
	"\x12FindBranchResponse\x12&\n" +
	"\x06branch\x18\x01 \x01(\v2\x0e.gitaly.BranchR\x06branch\"\x85\x02\n" +
	"\x17UpdateReferencesRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12@\n" +
	"\aupdates\x18\x02 \x03(\v2&.gitaly.UpdateReferencesRequest.UpdateR\aupdates\x1an\n" +
	"\x06Update\x12\x1c\n" +
	"\treference\x18\x01 \x01(\fR\treference\x12\"\n" +
	"\rold_object_id\x18\x02 \x01(\fR\voldObjectId\x12\"\n" +
	"\rnew_object_id\x18\x03 \x01(\fR\vnewObjectId\"\x1a\n" +
	"\x18UpdateReferencesResponse\"\x97\x02\n" +
	"\x15UpdateReferencesError\x12F\n" +
	"\x0einvalid_format\x18\x01 \x01(\v2\x1d.gitaly.InvalidRefFormatErrorH\x00R\rinvalidFormat\x12L\n" +
	"\x11references_locked\x18\x02 \x01(\v2\x1d.gitaly.ReferencesLockedErrorH\x00R\x10referencesLocked\x12_\n" +
	"\x18reference_state_mismatch\x18\x03 \x01(\v2#.gitaly.ReferenceStateMismatchErrorH\x00R\x16referenceStateMismatchB\a\n" +
	"\x05error\"\x8f\x01\n" +
	"\x11DeleteRefsRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12,\n" +
	"\x12except_with_prefix\x18\x02 \x03(\fR\x10exceptWithPrefix\x12\x12\n" +
	"\x04refs\x18\x03 \x03(\fR\x04refs\"1\n" +
	"\x12DeleteRefsResponse\x12\x1b\n" +
	"\tgit_error\x18\x01 \x01(\tR\bgitError\"\xb0\x01\n" +
	"\x0fDeleteRefsError\x12F\n" +
	"\x0einvalid_format\x18\x01 \x01(\v2\x1d.gitaly.InvalidRefFormatErrorH\x00R\rinvalidFormat\x12L\n" +
	"\x11references_locked\x18\x02 \x01(\v2\x1d.gitaly.ReferencesLockedErrorH\x00R\x10referencesLockedB\a\n" +
	"\x05error\"\x95\x01\n" +
	"&ListBranchNamesContainingCommitRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x1b\n" +
	"\tcommit_id\x18\x02 \x01(\tR\bcommitId\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\rR\x05limit\"R\n" +
	"'ListBranchNamesContainingCommitResponse\x12!\n" +
	"\fbranch_names\x18\x02 \x03(\fR\vbranchNamesJ\x04\b\x01\x10\x02\"\x92\x01\n" +
	"#ListTagNamesContainingCommitRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x1b\n" +
	"\tcommit_id\x18\x02 \x01(\tR\bcommitId\x12\x14\n" +
	"\x05limit\x18\x03 \x01(\rR\x05limit\"I\n" +
	"$ListTagNamesContainingCommitResponse\x12\x1b\n" +
	"\ttag_names\x18\x02 \x03(\fR\btagNamesJ\x04\b\x01\x10\x02\"x\n" +
	"\x17GetTagSignaturesRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12#\n" +
	"\rtag_revisions\x18\x02 \x03(\tR\ftagRevisions\"\xc8\x01\n" +
	"\x18GetTagSignaturesResponse\x12M\n" +
	"\n" +
	"signatures\x18\x01 \x03(\v2-.gitaly.GetTagSignaturesResponse.TagSignatureR\n" +
	"signatures\x1a]\n" +
	"\fTagSignature\x12\x15\n" +
	"\x06tag_id\x18\x01 \x01(\tR\x05tagId\x12\x1c\n" +
	"\tsignature\x18\x02 \x01(\fR\tsignature\x12\x18\n" +
	"\acontent\x18\x03 \x01(\fR\acontent\"{\n" +
	"\x15GetTagMessagesRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x17\n" +
	"\atag_ids\x18\x03 \x03(\tR\x06tagIdsJ\x04\b\x02\x10\x03R\ttag_names\"Y\n" +
	"\x16GetTagMessagesResponse\x12\x18\n" +
	"\amessage\x18\x02 \x01(\fR\amessage\x12\x15\n" +
	"\x06tag_id\x18\x03 \x01(\tR\x05tagIdJ\x04\b\x01\x10\x02R\btag_name\"y\n" +
	"\x1cFindAllRemoteBranchesRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x1f\n" +
	...
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x1a\n" +
	"\bpatterns\x18\x02 \x03(\fR\bpatterns\x12\x12\n" +
	"\x04head\x18\x03 \x01(\bR\x04head\x127\n" +
	...
	"\x03Key\x12\v\n" +
	"\aREFNAME\x10\x00\x12\x0f\n" +
	"\vCREATORDATE\x10\x01\x12\x0e\n" +
	"\n" +
	"AUTHORDATE\x10\x02\x12\x11\n" +
	"\rCOMMITTERDATE\x10\x03\"\xfb\x01\n" +
	"\x10ListRefsResponse\x12B\n" +
	"\n" +
	"references\x18\x01 \x03(\v2\".gitaly.ListRefsResponse.ReferenceR\n" +
	"references\x12E\n" +
	"\x11pagination_cursor\x18\x02 \x01(\v2\x18.gitaly.PaginationCursorR\x10paginationCursor\x1a\\\n" +
	"\tReference\x12\x12\n" +
	"\x04name\x18\x01 \x01(\fR\x04name\x12\x16\n" +
	"\x06target\x18\x02 \x01(\tR\x06target\x12#\n" +
	"\rpeeled_target\x18\x03 \x01(\tR\fpeeledTarget\"\xba\x01\n" +
	"\x14FindRefsByOIDRequest\x128\n" +
	"\n" +
	"repository\x18\x01 \x01(\v2\x12.gitaly.RepositoryB\x04\x98\xc6,\x01R\n" +
	"repository\x12\x10\n" +
	"\x03oid\x18\x02 \x01(\tR\x03oid\x12!\n" +
	"\fref_patterns\x18\x03 \x03(\tR\vrefPatterns\x12\x1d\n" +
	"\n" +
	"sort_field\x18\x04 \x01(\tR\tsortField\x12\x14\n" +
	"\x05limit\x18\x05 \x01(\rR\x05limit\"+\n" +
	"\x15FindRefsByOIDResponse\x12\x12\n" +
	"\x04refs\x18\x01 \x03(\tR\x04refs2\xf7\v\n" +
	"\n" +
	"RefService\x12l\n" +
	"\x15FindDefaultBranchName\x12$.gitaly.FindDefaultBranchNameRequest\x1a%.gitaly.FindDefaultBranchNameResponse\"\x06\xfa\x97(\x02\b\x02\x12b\n" +
	"\x11FindLocalBranches\x12 .gitaly.FindLocalBranchesRequest\x1a!.gitaly.FindLocalBranchesResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12\\\n" +
	"\x0fFindAllBranches\x12\x1e.gitaly.FindAllBranchesRequest\x1a\x1f.gitaly.FindAllBranchesResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12P\n" +
	"\vFindAllTags\x12\x1a.gitaly.FindAllTagsRequest\x1a\x1b.gitaly.FindAllTagsResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12B\n" +
	"\aFindTag\x12\x16.gitaly.FindTagRequest\x1a\x17.gitaly.FindTagResponse\"\x06\xfa\x97(\x02\b\x02\x12n\n" +
	"\x15FindAllRemoteBranches\x12$.gitaly.FindAllRemoteBranchesRequest\x1a%.gitaly.FindAllRemoteBranchesResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12H\n" +
	"\tRefExists\x12\x18.gitaly.RefExistsRequest\x1a\x19.gitaly.RefExistsResponse\"\x06\xfa\x97(\x02\b\x02\x12K\n" +
	"\n" +
	"FindBranch\x12\x19.gitaly.FindBranchRequest\x1a\x1a.gitaly.FindBranchResponse\"\x06\xfa\x97(\x02\b\x02\x12_\n" +
	"\x10UpdateReferences\x12\x1f.gitaly.UpdateReferencesRequest\x1a .gitaly.UpdateReferencesResponse\"\x06\xfa\x97(\x02\b\x01(\x01\x12K\n" +
	"\n" +
	"DeleteRefs\x12\x19.gitaly.DeleteRefsRequest\x1a\x1a.gitaly.DeleteRefsResponse\"\x06\xfa\x97(\x02\b\x01\x12\x8c\x01\n" +
	"\x1fListBranchNamesContainingCommit\x12..gitaly.ListBranchNamesContainingCommitRequest\x1a/.gitaly.ListBranchNamesContainingCommitResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12\x83\x01\n" +
	"\x1cListTagNamesContainingCommit\x12+.gitaly.ListTagNamesContainingCommitRequest\x1a,.gitaly.ListTagNamesContainingCommitResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12_\n" +
	"\x10GetTagSignatures\x12\x1f.gitaly.GetTagSignaturesRequest\x1a .gitaly.GetTagSignaturesResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12Y\n" +
	"\x0eGetTagMessages\x12\x1d.gitaly.GetTagMessagesRequest\x1a\x1e.gitaly.GetTagMessagesResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12G\n" +
	"\bListRefs\x12\x17.gitaly.ListRefsRequest\x1a\x18.gitaly.ListRefsResponse\"\x06\xfa\x97(\x02\b\x020\x01\x12T\n" +
	"\rFindRefsByOID\x12\x1c.gitaly.FindRefsByOIDRequest\x1a\x1d.gitaly.FindRefsByOIDResponse\"\x06\xfa\x97(\x02\b\x02B4Z2gitlab.com/gitlab-org/gitaly/v18/proto/go/gitalypbb\x06proto3"
...
var file_ref_proto_goTypes = []any{
	...
	(*PaginationCursor)(nil),                        // 52: gitaly.PaginationCursor
	(*GitCommit)(nil),                               // 53: gitaly.GitCommit
	(SortDirection)(0),                              // 54: gitaly.SortDirection
}
var file_ref_proto_depIdxs = []int32{
	...
	45, // 34: gitaly.ListRefsRequest.pagination_params:type_name -> gitaly.PaginationParameter
	43, // 35: gitaly.ListRefsResponse.references:type_name -> gitaly.ListRefsResponse.Reference
	52, // 36: gitaly.ListRefsResponse.pagination_cursor:type_name -> gitaly.PaginationCursor
	44, // 37: gitaly.FindRefsByOIDRequest.repository:type_name -> gitaly.Repository
	53, // 38: gitaly.FindAllBranchesResponse.Branch.target:type_name -> gitaly.GitCommit
	1,  // 39: gitaly.FindAllTagsRequest.SortBy.key:type_name -> gitaly.FindAllTagsRequest.SortBy.Key
	54, // 40: gitaly.FindAllTagsRequest.SortBy.direction:type_name -> gitaly.SortDirection
	2,  // 41: gitaly.ListRefsRequest.SortBy.key:type_name -> gitaly.ListRefsRequest.SortBy.Key
	54, // 42: gitaly.ListRefsRequest.SortBy.direction:type_name -> gitaly.SortDirection
	3,  // 43: gitaly.RefService.FindDefaultBranchName:input_type -> gitaly.FindDefaultBranchNameRequest
	5,  // 44: gitaly.RefService.FindLocalBranches:input_type -> gitaly.FindLocalBranchesRequest
	7,  // 45: gitaly.RefService.FindAllBranches:input_type -> gitaly.FindAllBranchesRequest
	12, // 46: gitaly.RefService.FindAllTags:input_type -> gitaly.FindAllTagsRequest
	9,  // 47: gitaly.RefService.FindTag:input_type -> gitaly.FindTagRequest
	32, // 48: gitaly.RefService.FindAllRemoteBranches:input_type -> gitaly.FindAllRemoteBranchesRequest
	14, // 49: gitaly.RefService.RefExists:input_type -> gitaly.RefExistsRequest
	16, // 50: gitaly.RefService.FindBranch:input_type -> gitaly.FindBranchRequest
	18, // 51: gitaly.RefService.UpdateReferences:input_type -> gitaly.UpdateReferencesRequest
	21, // 52: gitaly.RefService.DeleteRefs:input_type -> gitaly.DeleteRefsRequest
	24, // 53: gitaly.RefService.ListBranchNamesContainingCommit:input_type -> gitaly.ListBranchNamesContainingCommitRequest
	26, // 54: gitaly.RefService.ListTagNamesContainingCommit:input_type -> gitaly.ListTagNamesContainingCommitRequest
	28, // 55: gitaly.RefService.GetTagSignatures:input_type -> gitaly.GetTagSignaturesRequest
	30, // 56: gitaly.RefService.GetTagMessages:input_type -> gitaly.GetTagMessagesRequest
	34, // 57: gitaly.RefService.ListRefs:input_type -> gitaly.ListRefsRequest
	36, // 58: gitaly.RefService.FindRefsByOID:input_type -> gitaly.FindRefsByOIDRequest
	4,  // 59: gitaly.RefService.FindDefaultBranchName:output_type -> gitaly.FindDefaultBranchNameResponse
	6,  // 60: gitaly.RefService.FindLocalBranches:output_type -> gitaly.FindLocalBranchesResponse
	8,  // 61: gitaly.RefService.FindAllBranches:output_type -> gitaly.FindAllBranchesResponse
	13, // 62: gitaly.RefService.FindAllTags:output_type -> gitaly.FindAllTagsResponse
	10, // 63: gitaly.RefService.FindTag:output_type -> gitaly.FindTagResponse
	33, // 64: gitaly.RefService.FindAllRemoteBranches:output_type -> gitaly.FindAllRemoteBranchesResponse
	15, // 65: gitaly.RefService.RefExists:output_type -> gitaly.RefExistsResponse
	17, // 66: gitaly.RefService.FindBranch:output_type -> gitaly.FindBranchResponse
	19, // 67: gitaly.RefService.UpdateReferences:output_type -> gitaly.UpdateReferencesResponse
	22, // 68: gitaly.RefService.DeleteRefs:output_type -> gitaly.DeleteRefsResponse
	25, // 69: gitaly.RefService.ListBranchNamesContainingCommit:output_type -> gitaly.ListBranchNamesContainingCommitResponse
	27, // 70: gitaly.RefService.ListTagNamesContainingCommit:output_type -> gitaly.ListTagNamesContainingCommitResponse
	29, // 71: gitaly.RefService.GetTagSignatures:output_type -> gitaly.GetTagSignaturesResponse
	31, // 72: gitaly.RefService.GetTagMessages:output_type -> gitaly.GetTagMessagesResponse
	35, // 73: gitaly.RefService.ListRefs:output_type -> gitaly.ListRefsResponse
	37, // 74: gitaly.RefService.FindRefsByOID:output_type -> gitaly.FindRefsByOIDResponse
