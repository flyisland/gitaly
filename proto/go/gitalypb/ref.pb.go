...
var file_ref_proto_rawDesc = string([]byte{
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x12, 0x62,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x12, 0x5f, 0x0a,
	0x10, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65,
	0x73, 0x12, 0x1f, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74,
	0x65, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x20, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x70, 0x64, 0x61,
	0x74, 0x65, 0x52, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x01, 0x28, 0x01, 0x12, 0x4b,
...
var file_ref_proto_depIdxs = []int32{
	...
	44, // 36: gitaly.FindRefsByOIDRequest.repository:type_name -> gitaly.Repository
	52, // 37: gitaly.FindAllBranchesResponse.Branch.target:type_name -> gitaly.GitCommit
	1,  // 38: gitaly.FindAllTagsRequest.SortBy.key:type_name -> gitaly.FindAllTagsRequest.SortBy.Key
	53, // 39: gitaly.FindAllTagsRequest.SortBy.direction:type_name -> gitaly.SortDirection
	2,  // 40: gitaly.ListRefsRequest.SortBy.key:type_name -> gitaly.ListRefsRequest.SortBy.Key
	53, // 41: gitaly.ListRefsRequest.SortBy.direction:type_name -> gitaly.SortDirection
	3,  // 42: gitaly.RefService.FindDefaultBranchName:input_type -> gitaly.FindDefaultBranchNameRequest
	5,  // 43: gitaly.RefService.FindLocalBranches:input_type -> gitaly.FindLocalBranchesRequest
	7,  // 44: gitaly.RefService.FindAllBranches:input_type -> gitaly.FindAllBranchesRequest
	12, // 45: gitaly.RefService.FindAllTags:input_type -> gitaly.FindAllTagsRequest
	9,  // 46: gitaly.RefService.FindTag:input_type -> gitaly.FindTagRequest
	32, // 47: gitaly.RefService.FindAllRemoteBranches:input_type -> gitaly.FindAllRemoteBranchesRequest
	14, // 48: gitaly.RefService.RefExists:input_type -> gitaly.RefExistsRequest
	16, // 49: gitaly.RefService.FindBranch:input_type -> gitaly.FindBranchRequest
	18, // 50: gitaly.RefService.UpdateReferences:input_type -> gitaly.UpdateReferencesRequest
	21, // 51: gitaly.RefService.DeleteRefs:input_type -> gitaly.DeleteRefsRequest
	24, // 52: gitaly.RefService.ListBranchNamesContainingCommit:input_type -> gitaly.ListBranchNamesContainingCommitRequest
	26, // 53: gitaly.RefService.ListTagNamesContainingCommit:input_type -> gitaly.ListTagNamesContainingCommitRequest
	28, // 54: gitaly.RefService.GetTagSignatures:input_type -> gitaly.GetTagSignaturesRequest
	30, // 55: gitaly.RefService.GetTagMessages:input_type -> gitaly.GetTagMessagesRequest
	34, // 56: gitaly.RefService.ListRefs:input_type -> gitaly.ListRefsRequest
	36, // 57: gitaly.RefService.FindRefsByOID:input_type -> gitaly.FindRefsByOIDRequest
	4,  // 58: gitaly.RefService.FindDefaultBranchName:output_type -> gitaly.FindDefaultBranchNameResponse
	6,  // 59: gitaly.RefService.FindLocalBranches:output_type -> gitaly.FindLocalBranchesResponse
	8,  // 60: gitaly.RefService.FindAllBranches:output_type -> gitaly.FindAllBranchesResponse
	13, // 61: gitaly.RefService.FindAllTags:output_type -> gitaly.FindAllTagsResponse
	10, // 62: gitaly.RefService.FindTag:output_type -> gitaly.FindTagResponse
	33, // 63: gitaly.RefService.FindAllRemoteBranches:output_type -> gitaly.FindAllRemoteBranchesResponse
	15, // 64: gitaly.RefService.RefExists:output_type -> gitaly.RefExistsResponse
	17, // 65: gitaly.RefService.FindBranch:output_type -> gitaly.FindBranchResponse
	19, // 66: gitaly.RefService.UpdateReferences:output_type -> gitaly.UpdateReferencesResponse
	22, // 67: gitaly.RefService.DeleteRefs:output_type -> gitaly.DeleteRefsResponse
	25, // 68: gitaly.RefService.ListBranchNamesContainingCommit:output_type -> gitaly.ListBranchNamesContainingCommitResponse
	27, // 69: gitaly.RefService.ListTagNamesContainingCommit:output_type -> gitaly.ListTagNamesContainingCommitResponse
	29, // 70: gitaly.RefService.GetTagSignatures:output_type -> gitaly.GetTagSignaturesResponse
	31, // 71: gitaly.RefService.GetTagMessages:output_type -> gitaly.GetTagMessagesResponse
	35, // 72: gitaly.RefService.ListRefs:output_type -> gitaly.ListRefsResponse
	37, // 73: gitaly.RefService.FindRefsByOID:output_type -> gitaly.FindRefsByOIDResponse
