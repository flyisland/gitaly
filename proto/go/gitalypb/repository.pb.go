...
var file_repository_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x8f,
...
var file_repository_proto_msgTypes = make([]protoimpl.MessageInfo, 92)
var file_repository_proto_goTypes = []any{
	...
	(*RemoteNotFoundError)(nil),                                 // 98: gitaly.RemoteNotFoundError
}
var file_repository_proto_depIdxs = []int32{
	...
	98,  // 24: gitaly.CreateRepositoryFromURLError.remote_not_found:type_name -> gitaly.RemoteNotFoundError
	...
	0,   // 57: gitaly.RepositoryInfoResponse.ReferencesInfo.reference_backend:type_name -> gitaly.RepositoryInfoResponse.ReferencesInfo.ReferenceBackend
	...
	6,   // 60: gitaly.RepositoryService.RepositorySize:input_type -> gitaly.RepositorySizeRequest
	8,   // 61: gitaly.RepositoryService.RepositoryInfo:input_type -> gitaly.RepositoryInfoRequest
	10,  // 62: gitaly.RepositoryService.ObjectsSize:input_type -> gitaly.ObjectsSizeRequest
	12,  // 63: gitaly.RepositoryService.ObjectFormat:input_type -> gitaly.ObjectFormatRequest
	16,  // 64: gitaly.RepositoryService.FetchRemote:input_type -> gitaly.FetchRemoteRequest
	18,  // 65: gitaly.RepositoryService.CreateRepository:input_type -> gitaly.CreateRepositoryRequest
	20,  // 66: gitaly.RepositoryService.GetArchive:input_type -> gitaly.GetArchiveRequest
	22,  // 67: gitaly.RepositoryService.HasLocalBranches:input_type -> gitaly.HasLocalBranchesRequest
	24,  // 68: gitaly.RepositoryService.FetchSourceBranch:input_type -> gitaly.FetchSourceBranchRequest
	26,  // 69: gitaly.RepositoryService.Fsck:input_type -> gitaly.FsckRequest
	28,  // 70: gitaly.RepositoryService.WriteRef:input_type -> gitaly.WriteRefRequest
	30,  // 71: gitaly.RepositoryService.FindMergeBase:input_type -> gitaly.FindMergeBaseRequest
	32,  // 72: gitaly.RepositoryService.CreateFork:input_type -> gitaly.CreateForkRequest
	34,  // 73: gitaly.RepositoryService.CreateRepositoryFromURL:input_type -> gitaly.CreateRepositoryFromURLRequest
	...
	14,  // 77: gitaly.RepositoryService.FetchBundle:input_type -> gitaly.FetchBundleRequest
	...
	5,   // 101: gitaly.RepositoryService.RepositoryExists:output_type -> gitaly.RepositoryExistsResponse
	7,   // 102: gitaly.RepositoryService.RepositorySize:output_type -> gitaly.RepositorySizeResponse
	9,   // 103: gitaly.RepositoryService.RepositoryInfo:output_type -> gitaly.RepositoryInfoResponse
	11,  // 104: gitaly.RepositoryService.ObjectsSize:output_type -> gitaly.ObjectsSizeResponse
	13,  // 105: gitaly.RepositoryService.ObjectFormat:output_type -> gitaly.ObjectFormatResponse
	17,  // 106: gitaly.RepositoryService.FetchRemote:output_type -> gitaly.FetchRemoteResponse
	19,  // 107: gitaly.RepositoryService.CreateRepository:output_type -> gitaly.CreateRepositoryResponse
	21,  // 108: gitaly.RepositoryService.GetArchive:output_type -> gitaly.GetArchiveResponse
	23,  // 109: gitaly.RepositoryService.HasLocalBranches:output_type -> gitaly.HasLocalBranchesResponse
	25,  // 110: gitaly.RepositoryService.FetchSourceBranch:output_type -> gitaly.FetchSourceBranchResponse
	27,  // 111: gitaly.RepositoryService.Fsck:output_type -> gitaly.FsckResponse
	29,  // 112: gitaly.RepositoryService.WriteRef:output_type -> gitaly.WriteRefResponse
	31,  // 113: gitaly.RepositoryService.FindMergeBase:output_type -> gitaly.FindMergeBaseResponse
	33,  // 114: gitaly.RepositoryService.CreateFork:output_type -> gitaly.CreateForkResponse
	35,  // 115: gitaly.RepositoryService.CreateRepositoryFromURL:output_type -> gitaly.CreateRepositoryFromURLResponse
	38,  // 116: gitaly.RepositoryService.CreateBundle:output_type -> gitaly.CreateBundleResponse
	40,  // 117: gitaly.RepositoryService.CreateBundleFromRefList:output_type -> gitaly.CreateBundleFromRefListResponse
	42,  // 118: gitaly.RepositoryService.GenerateBundleURI:output_type -> gitaly.GenerateBundleURIResponse
	15,  // 119: gitaly.RepositoryService.FetchBundle:output_type -> gitaly.FetchBundleResponse
	54,  // 120: gitaly.RepositoryService.CreateRepositoryFromBundle:output_type -> gitaly.CreateRepositoryFromBundleResponse
	44,  // 121: gitaly.RepositoryService.GetConfig:output_type -> gitaly.GetConfigResponse
	56,  // 122: gitaly.RepositoryService.FindLicense:output_type -> gitaly.FindLicenseResponse
	58,  // 123: gitaly.RepositoryService.GetInfoAttributes:output_type -> gitaly.GetInfoAttributesResponse
	60,  // 124: gitaly.RepositoryService.CalculateChecksum:output_type -> gitaly.CalculateChecksumResponse
	62,  // 125: gitaly.RepositoryService.GetSnapshot:output_type -> gitaly.GetSnapshotResponse
	64,  // 126: gitaly.RepositoryService.CreateRepositoryFromSnapshot:output_type -> gitaly.CreateRepositoryFromSnapshotResponse
	66,  // 127: gitaly.RepositoryService.GetRawChanges:output_type -> gitaly.GetRawChangesResponse
	70,  // 128: gitaly.RepositoryService.SearchFilesByContent:output_type -> gitaly.SearchFilesByContentResponse
	68,  // 129: gitaly.RepositoryService.SearchFilesByName:output_type -> gitaly.SearchFilesByNameResponse
	47,  // 130: gitaly.RepositoryService.RestoreCustomHooks:output_type -> gitaly.RestoreCustomHooksResponse
	48,  // 131: gitaly.RepositoryService.SetCustomHooks:output_type -> gitaly.SetCustomHooksResponse
	51,  // 132: gitaly.RepositoryService.BackupCustomHooks:output_type -> gitaly.BackupCustomHooksResponse
	52,  // 133: gitaly.RepositoryService.GetCustomHooks:output_type -> gitaly.GetCustomHooksResponse
	73,  // 134: gitaly.RepositoryService.GetObjectDirectorySize:output_type -> gitaly.GetObjectDirectorySizeResponse
	75,  // 135: gitaly.RepositoryService.RemoveRepository:output_type -> gitaly.RemoveRepositoryResponse
	77,  // 136: gitaly.RepositoryService.ReplicateRepository:output_type -> gitaly.ReplicateRepositoryResponse
	79,  // 137: gitaly.RepositoryService.OptimizeRepository:output_type -> gitaly.OptimizeRepositoryResponse
	81,  // 138: gitaly.RepositoryService.PruneUnreachableObjects:output_type -> gitaly.PruneUnreachableObjectsResponse
	83,  // 139: gitaly.RepositoryService.BackupRepository:output_type -> gitaly.BackupRepositoryResponse
	85,  // 140: gitaly.RepositoryService.RestoreRepository:output_type -> gitaly.RestoreRepositoryResponse
	87,  // 141: gitaly.RepositoryService.GetFileAttributes:output_type -> gitaly.GetFileAttributesResponse
	89,  // 142: gitaly.RepositoryService.FastExport:output_type -> gitaly.FastExportResponse
