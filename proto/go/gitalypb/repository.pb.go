...
const (
	...
	OptimizeRepositoryRequest_STRATEGY_REHYDRATION OptimizeRepositoryRequest_Strategy = 4
)
...
// ReferenceBackend denotes the type of backend used to store references.
type MigrateReferenceBackendRequest_ReferenceBackend int32

const (
	// REFERENCE_BACKEND_UNSPECIFIED is the default value and should never be set.
	MigrateReferenceBackendRequest_REFERENCE_BACKEND_UNSPECIFIED MigrateReferenceBackendRequest_ReferenceBackend = 0
	// REFERENCE_BACKEND_FILES is the traditional backend built using files/directories.
	MigrateReferenceBackendRequest_REFERENCE_BACKEND_FILES MigrateReferenceBackendRequest_ReferenceBackend = 1
	// REFERENCE_BACKEND_REFTABLE is the new backend using customized binary file format.
	MigrateReferenceBackendRequest_REFERENCE_BACKEND_REFTABLE MigrateReferenceBackendRequest_ReferenceBackend = 2
)

// Enum value maps for MigrateReferenceBackendRequest_ReferenceBackend.
var (
	MigrateReferenceBackendRequest_ReferenceBackend_name = map[int32]string{
		0: "REFERENCE_BACKEND_UNSPECIFIED",
		1: "REFERENCE_BACKEND_FILES",
		2: "REFERENCE_BACKEND_REFTABLE",
	}
	MigrateReferenceBackendRequest_ReferenceBackend_value = map[string]int32{
		"REFERENCE_BACKEND_UNSPECIFIED": 0,
		"REFERENCE_BACKEND_FILES":       1,
		"REFERENCE_BACKEND_REFTABLE":    2,
	}
...
func (x MigrateReferenceBackendRequest_ReferenceBackend) Enum() *MigrateReferenceBackendRequest_ReferenceBackend {
	p := new(MigrateReferenceBackendRequest_ReferenceBackend)
	*p = x
	return p
}

func (x MigrateReferenceBackendRequest_ReferenceBackend) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MigrateReferenceBackendRequest_ReferenceBackend) Descriptor() protoreflect.EnumDescriptor {
	return file_repository_proto_enumTypes[4].Descriptor()
}

func (MigrateReferenceBackendRequest_ReferenceBackend) Type() protoreflect.EnumType {
	return &file_repository_proto_enumTypes[4]
}

func (x MigrateReferenceBackendRequest_ReferenceBackend) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MigrateReferenceBackendRequest_ReferenceBackend.Descriptor instead.
func (MigrateReferenceBackendRequest_ReferenceBackend) EnumDescriptor() ([]byte, []int) {
...
type MigrateReferenceBackendRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// repository is the repository to run migrations on.
	Repository *Repository `protobuf:"bytes,1,opt,name=repository,proto3" json:"repository,omitempty"`
	// target_reference_backend is the backend to migrate to.
	TargetReferenceBackend MigrateReferenceBackendRequest_ReferenceBackend `protobuf:"varint,2,opt,name=target_reference_backend,json=targetReferenceBackend,proto3,enum=gitaly.MigrateReferenceBackendRequest_ReferenceBackend" json:"target_reference_backend,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}

func (x *MigrateReferenceBackendRequest) Reset() {
	*x = MigrateReferenceBackendRequest{}
	mi := &file_repository_proto_msgTypes[86]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MigrateReferenceBackendRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrateReferenceBackendRequest) ProtoMessage() {}

func (x *MigrateReferenceBackendRequest) ProtoReflect() protoreflect.Message {
	mi := &file_repository_proto_msgTypes[86]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrateReferenceBackendRequest.ProtoReflect.Descriptor instead.
func (*MigrateReferenceBackendRequest) Descriptor() ([]byte, []int) {
	return file_repository_proto_rawDescGZIP(), []int{86}
}

func (x *MigrateReferenceBackendRequest) GetRepository() *Repository {
	if x != nil {
		return x.Repository
	}
	return nil
...
func (x *MigrateReferenceBackendRequest) GetTargetReferenceBackend() MigrateReferenceBackendRequest_ReferenceBackend {
	if x != nil {
		return x.TargetReferenceBackend
	}
	return MigrateReferenceBackendRequest_REFERENCE_BACKEND_UNSPECIFIED
}

// MigrateReferenceBackendResponse is a response for the MigrateReferenceBackend RPC.
type MigrateReferenceBackendResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MigrateReferenceBackendResponse) Reset() {
	*x = MigrateReferenceBackendResponse{}
	mi := &file_repository_proto_msgTypes[87]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MigrateReferenceBackendResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MigrateReferenceBackendResponse) ProtoMessage() {}

func (x *MigrateReferenceBackendResponse) ProtoReflect() protoreflect.Message {
	mi := &file_repository_proto_msgTypes[87]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MigrateReferenceBackendResponse.ProtoReflect.Descriptor instead.
func (*MigrateReferenceBackendResponse) Descriptor() ([]byte, []int) {
	return file_repository_proto_rawDescGZIP(), []int{87}
}

func (x *MigrateReferenceBackendResponse) GetTime() *durationpb.Duration {
	if x != nil {
		return x.Time
	}
	return nil
...
type RepositoryInfoResponse_MultiPackIndexInfo struct {
	...
	HasLargeOffsets bool `protobuf:"varint,3,opt,name=has_large_offsets,json=hasLargeOffsets,proto3" json:"has_large_offsets,omitempty"`
	...
	HasBitmappedPacks bool `protobuf:"varint,4,opt,name=has_bitmapped_packs,json=hasBitmappedPacks,proto3" json:"has_bitmapped_packs,omitempty"`
	...
	HasReverseIndex bool `protobuf:"varint,5,opt,name=has_reverse_index,json=hasReverseIndex,proto3" json:"has_reverse_index,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *RepositoryInfoResponse_MultiPackIndexInfo) GetHasLargeOffsets() bool {
	if x != nil {
		return x.HasLargeOffsets
	}
	return false
}

func (x *RepositoryInfoResponse_MultiPackIndexInfo) GetHasBitmappedPacks() bool {
	if x != nil {
		return x.HasBitmappedPacks
	}
	return false
}

func (x *RepositoryInfoResponse_MultiPackIndexInfo) GetHasReverseIndex() bool {
	if x != nil {
		return x.HasReverseIndex
	}
	return false
}
...
var file_repository_proto_rawDesc = string([]byte{
	...
	0x22, 0x90, 0x11, 0x0a, 0x16, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x49,
	...
	,
	...
	0x69, 0x65, 0x64, 0x22, 0x6c, 0x0a, 0x12, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x53, 0x69,
	...
	0x73, 0x22, 0x29, 0x0a, 0x13, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x53, 0x69, 0x7a, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x22, 0x4f, 0x0a, 0x13,
	...
	0x01, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x44, 0x0a,
	0x14, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x06, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x14, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x46, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x52, 0x06, 0x66, 0x6f, 0x72,
	0x6d, 0x61, 0x74, 0x22, 0x83, 0x01, 0x0a, 0x12, 0x46, 0x65, 0x74, 0x63, 0x68, 0x42, 0x75, 0x6e,
	...
	0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x22, 0x5b, 0x0a, 0x13, 0x46, 0x65, 0x74, 0x63, 0x68, 0x52,
	...
	0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x70, 0x6f, 0x5f, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x72, 0x65, 0x70, 0x6f, 0x43, 0x68, 0x61, 0x6e,
	0x67, 0x65, 0x64, 0x22, 0xb5, 0x01, 0x0a, 0x17, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65,
	...
	,
	...
	0x69, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x18, 0x03,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x70, 0x72, 0x65, 0x66, 0x69, 0x78, 0x12, 0x38, 0x0a, 0x06,
	0x66, 0x6f, 0x72, 0x6d, 0x61, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x67,
	...
	,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0x90, 0x02, 0x0a, 0x18, 0x46, 0x65, 0x74, 0x63, 0x68, 0x53,
	...
	,
	...
	0x0b, 0x46, 0x73, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0a,
	...
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x24, 0x0a, 0x0c, 0x46, 0x73, 0x63, 0x6b, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xaf, 0x01, 0x0a,
	0x0f, 0x57, 0x72, 0x69, 0x74, 0x65, 0x52, 0x65, 0x66, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	,
	...
	0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x2b, 0x0a, 0x15, 0x46, 0x69, 0x6e, 0x64,
	...
	0x04, 0x62, 0x61, 0x73, 0x65, 0x22, 0xaa, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x46, 0x6f, 0x72, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x72,
	...
	,
	...
	0x61, 0x64, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x17, 0x68, 0x74, 0x74, 0x70,
	0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x65, 0x61,
	0x64, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x05, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x06, 0x6d, 0x69, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x29, 0x0a, 0x10, 0x72,
	...
	,
	...
	0x2c, 0x01, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x22, 0x1b,
	0x0a, 0x19, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x42, 0x75, 0x6e, 0x64, 0x6c, 0x65,
	0x55, 0x52, 0x49, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x4c, 0x0a, 0x10, 0x47,
	...
	0x6f, 0x52, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x8f, 0x04, 0x0a, 0x15, 0x47, 0x65,
	...
	0x65, 0x52, 0x0a, 0x72, 0x61, 0x77, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x1a, 0xab, 0x03,
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x73, 0x22, 0x97, 0x01, 0x0a, 0x1b, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x46, 0x69,
	...
	,
	...
	0x64, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x4a, 0x04,
	0x08, 0x05, 0x10, 0x06, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x52, 0x09, 0x68, 0x74, 0x74, 0x70,
	0x5f, 0x68, 0x6f, 0x73, 0x74, 0x22, 0x59, 0x0a, 0x1d, 0x47, 0x65, 0x74, 0x4f, 0x62, 0x6a, 0x65,
	...
	0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xa5, 0x02, 0x0a, 0x19,
	...
	0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	0x79, 0x42, 0x04, 0x98, 0xc6, 0x2c, 0x01, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
	0x6f, 0x72, 0x79, 0x12, 0x46, 0x0a, 0x08, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2a, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x4f,
	0x70, 0x74, 0x69, 0x6d, 0x69, 0x7a, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72,
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x53, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67,
	0x79, 0x52, 0x08, 0x73, 0x74, 0x72, 0x61, 0x74, 0x65, 0x67, 0x79, 0x22, 0x85, 0x01, 0x0a, 0x08,
	...
	0x10, 0x00, 0x12, 0x18, 0x0a, 0x14, 0x53, 0x54, 0x52, 0x41, 0x54, 0x45, 0x47, 0x59, 0x5f, 0x48,
	0x45, 0x55, 0x52, 0x49, 0x53, 0x54, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e,
	0x53, 0x54, 0x52, 0x41, 0x54, 0x45, 0x47, 0x59, 0x5f, 0x45, 0x41, 0x47, 0x45, 0x52, 0x10, 0x02,
	0x12, 0x17, 0x0a, 0x13, 0x53, 0x54, 0x52, 0x41, 0x54, 0x45, 0x47, 0x59, 0x5f, 0x4f, 0x46, 0x46,
	0x4c, 0x4f, 0x41, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x03, 0x12, 0x18, 0x0a, 0x14, 0x53, 0x54, 0x52,
	0x41, 0x54, 0x45, 0x47, 0x59, 0x5f, 0x52, 0x45, 0x48, 0x59, 0x44, 0x52, 0x41, 0x54, 0x49, 0x4f,
	0x4e, 0x10, 0x04, 0x22, 0x1c, 0x0a, 0x1a, 0x4f, 0x70, 0x74, 0x69, 0x6d, 0x69, 0x7a, 0x65, 0x52,
	...
	,
	...
	,
	...
	,
	...
	0x28, 0x02, 0x08, 0x01, 0x28, 0x01, 0x12, 0x4a, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x12, 0x18, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x47, 0x65, 0x74,
	...
	,
	...
	0x6c, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62,
	0x75, 0x74, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x09, 0xfa, 0x97,
	0x28, 0x02, 0x08, 0x02, 0x88, 0x02, 0x01, 0x30, 0x01, 0x12, 0x60, 0x0a, 0x11, 0x43, 0x61, 0x6c,
	0x63, 0x75, 0x6c, 0x61, 0x74, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x12, 0x20,
	...
	0x1a, 0x21, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c,
	0x61, 0x74, 0x65, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x12, 0x50, 0x0a, 0x0b, 0x47,
	0x65, 0x74, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x1a, 0x2e, 0x67, 0x69, 0x74,
	...
	0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x30, 0x01, 0x12, 0x81, 0x01,
	0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f,
	0x72, 0x79, 0x46, 0x72, 0x6f, 0x6d, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x2b,
	...
	0x73, 0x68, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x67, 0x69,
	...
	,
	...
	0x74, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97,
	0x28, 0x02, 0x08, 0x02, 0x30, 0x01, 0x12, 0x62, 0x0a, 0x11, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68,
	0x46, 0x69, 0x6c, 0x65, 0x73, 0x42, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x20, 0x2e, 0x67, 0x69,
	...
	0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02, 0x30, 0x01, 0x12, 0x68, 0x0a, 0x12, 0x52, 0x65,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x48, 0x6f, 0x6f, 0x6b, 0x73,
	0x12, 0x21, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x52, 0x65, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x48, 0x6f, 0x6f, 0x6b, 0x73, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x52, 0x65, 0x73,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x1a, 0x26, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x4f,
	...
	0x08, 0x02, 0x12, 0x5d, 0x0a, 0x10, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x70, 0x6f,
	...
	0x0a, 0x17, 0x50, 0x72, 0x75, 0x6e, 0x65, 0x55, 0x6e, 0x72, 0x65, 0x61, 0x63, 0x68, 0x61, 0x62,
	0x6c, 0x65, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x12, 0x26, 0x2e, 0x67, 0x69, 0x74, 0x61,
	...
	0x74, 0x1a, 0x27, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x50, 0x72, 0x75, 0x6e, 0x65,
	...
	0x08, 0x03, 0x12, 0x5d, 0x0a, 0x10, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52, 0x65, 0x70, 0x6f,
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x1f, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e,
	...
	,
	...
	0x67, 0x2f, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2f, 0x76, 0x31, 0x38, 0x2f, 0x70, 0x72, 0x6f,
...
var file_repository_proto_goTypes = []any{
	...
	(MigrateReferenceBackendRequest_ReferenceBackend)(0),        // 4: gitaly.MigrateReferenceBackendRequest.ReferenceBackend
	(*RepositoryExistsRequest)(nil),                             // 5: gitaly.RepositoryExistsRequest
	(*RepositoryExistsResponse)(nil),                            // 6: gitaly.RepositoryExistsResponse
	(*RepositorySizeRequest)(nil),                               // 7: gitaly.RepositorySizeRequest
	(*RepositorySizeResponse)(nil),                              // 8: gitaly.RepositorySizeResponse
	(*RepositoryInfoRequest)(nil),                               // 9: gitaly.RepositoryInfoRequest
	(*RepositoryInfoResponse)(nil),                              // 10: gitaly.RepositoryInfoResponse
	(*ObjectsSizeRequest)(nil),                                  // 11: gitaly.ObjectsSizeRequest
	(*ObjectsSizeResponse)(nil),                                 // 12: gitaly.ObjectsSizeResponse
	(*ObjectFormatRequest)(nil),                                 // 13: gitaly.ObjectFormatRequest
	(*ObjectFormatResponse)(nil),                                // 14: gitaly.ObjectFormatResponse
	...
	(*MigrateReferenceBackendRequest)(nil),                      // 91: gitaly.MigrateReferenceBackendRequest
	(*MigrateReferenceBackendResponse)(nil),                     // 92: gitaly.MigrateReferenceBackendResponse
	(*RepositoryInfoResponse_ReferencesInfo)(nil),               // 93: gitaly.RepositoryInfoResponse.ReferencesInfo
	(*RepositoryInfoResponse_ObjectsInfo)(nil),                  // 94: gitaly.RepositoryInfoResponse.ObjectsInfo
	(*RepositoryInfoResponse_CommitGraphInfo)(nil),              // 95: gitaly.RepositoryInfoResponse.CommitGraphInfo
	(*RepositoryInfoResponse_BitmapInfo)(nil),                   // 96: gitaly.RepositoryInfoResponse.BitmapInfo
	(*RepositoryInfoResponse_MultiPackIndexInfo)(nil),           // 97: gitaly.RepositoryInfoResponse.MultiPackIndexInfo
	(*RepositoryInfoResponse_AlternatesInfo)(nil),               // 98: gitaly.RepositoryInfoResponse.AlternatesInfo
	(*GetRawChangesResponse_RawChange)(nil),                     // 99: gitaly.GetRawChangesResponse.RawChange
	(*BackupRepositoryResponse_SkippedError)(nil),               // 100: gitaly.BackupRepositoryResponse.SkippedError
	(*RestoreRepositoryResponse_SkippedError)(nil),              // 101: gitaly.RestoreRepositoryResponse.SkippedError
	(*GetFileAttributesResponse_AttributeInfo)(nil),             // 102: gitaly.GetFileAttributesResponse.AttributeInfo
	(*Repository)(nil),                                          // 103: gitaly.Repository
	(*timestamppb.Timestamp)(nil),                               // 104: google.protobuf.Timestamp
	(ObjectFormat)(0),                                           // 105: gitaly.ObjectFormat
	(*RemoteNotFoundError)(nil),                                 // 106: gitaly.RemoteNotFoundError
	(*durationpb.Duration)(nil),                                 // 107: google.protobuf.Duration
}
var file_repository_proto_depIdxs = []int32{
	103, // 0: gitaly.RepositoryExistsRequest.repository:type_name -> gitaly.Repository
	103, // 1: gitaly.RepositorySizeRequest.repository:type_name -> gitaly.Repository
	103, // 2: gitaly.RepositoryInfoRequest.repository:type_name -> gitaly.Repository
	93,  // 3: gitaly.RepositoryInfoResponse.references:type_name -> gitaly.RepositoryInfoResponse.ReferencesInfo
	94,  // 4: gitaly.RepositoryInfoResponse.objects:type_name -> gitaly.RepositoryInfoResponse.ObjectsInfo
	95,  // 5: gitaly.RepositoryInfoResponse.commit_graph:type_name -> gitaly.RepositoryInfoResponse.CommitGraphInfo
	96,  // 6: gitaly.RepositoryInfoResponse.bitmap:type_name -> gitaly.RepositoryInfoResponse.BitmapInfo
	97,  // 7: gitaly.RepositoryInfoResponse.multi_pack_index:type_name -> gitaly.RepositoryInfoResponse.MultiPackIndexInfo
	96,  // 8: gitaly.RepositoryInfoResponse.multi_pack_index_bitmap:type_name -> gitaly.RepositoryInfoResponse.BitmapInfo
	98,  // 9: gitaly.RepositoryInfoResponse.alternates:type_name -> gitaly.RepositoryInfoResponse.AlternatesInfo
	104, // 10: gitaly.RepositoryInfoResponse.last_full_repack:type_name -> google.protobuf.Timestamp
	103, // 11: gitaly.ObjectsSizeRequest.repository:type_name -> gitaly.Repository
	103, // 12: gitaly.ObjectFormatRequest.repository:type_name -> gitaly.Repository
	105, // 13: gitaly.ObjectFormatResponse.format:type_name -> gitaly.ObjectFormat
	103, // 14: gitaly.FetchBundleRequest.repository:type_name -> gitaly.Repository
	103, // 15: gitaly.FetchRemoteRequest.repository:type_name -> gitaly.Repository
	72,  // 16: gitaly.FetchRemoteRequest.remote_params:type_name -> gitaly.Remote
	103, // 17: gitaly.CreateRepositoryRequest.repository:type_name -> gitaly.Repository
	105, // 18: gitaly.CreateRepositoryRequest.object_format:type_name -> gitaly.ObjectFormat
	103, // 19: gitaly.GetArchiveRequest.repository:type_name -> gitaly.Repository
	1,   // 20: gitaly.GetArchiveRequest.format:type_name -> gitaly.GetArchiveRequest.Format
	103, // 21: gitaly.HasLocalBranchesRequest.repository:type_name -> gitaly.Repository
	103, // 22: gitaly.FetchSourceBranchRequest.repository:type_name -> gitaly.Repository
	103, // 23: gitaly.FetchSourceBranchRequest.source_repository:type_name -> gitaly.Repository
	103, // 24: gitaly.FsckRequest.repository:type_name -> gitaly.Repository
	103, // 25: gitaly.WriteRefRequest.repository:type_name -> gitaly.Repository
	103, // 26: gitaly.FindMergeBaseRequest.repository:type_name -> gitaly.Repository
	103, // 27: gitaly.CreateForkRequest.repository:type_name -> gitaly.Repository
	103, // 28: gitaly.CreateForkRequest.source_repository:type_name -> gitaly.Repository
	103, // 29: gitaly.CreateRepositoryFromURLRequest.repository:type_name -> gitaly.Repository
	106, // 30: gitaly.CreateRepositoryFromURLError.remote_not_found:type_name -> gitaly.RemoteNotFoundError
	103, // 31: gitaly.CreateBundleRequest.repository:type_name -> gitaly.Repository
	103, // 32: gitaly.CreateBundleFromRefListRequest.repository:type_name -> gitaly.Repository
	103, // 33: gitaly.GenerateBundleURIRequest.repository:type_name -> gitaly.Repository
	103, // 34: gitaly.GetConfigRequest.repository:type_name -> gitaly.Repository
	103, // 35: gitaly.RestoreCustomHooksRequest.repository:type_name -> gitaly.Repository
	103, // 36: gitaly.SetCustomHooksRequest.repository:type_name -> gitaly.Repository
	103, // 37: gitaly.BackupCustomHooksRequest.repository:type_name -> gitaly.Repository
	103, // 38: gitaly.GetCustomHooksRequest.repository:type_name -> gitaly.Repository
	103, // 39: gitaly.CreateRepositoryFromBundleRequest.repository:type_name -> gitaly.Repository
	103, // 40: gitaly.FindLicenseRequest.repository:type_name -> gitaly.Repository
	103, // 41: gitaly.GetInfoAttributesRequest.repository:type_name -> gitaly.Repository
	103, // 42: gitaly.CalculateChecksumRequest.repository:type_name -> gitaly.Repository
	103, // 43: gitaly.GetSnapshotRequest.repository:type_name -> gitaly.Repository
	103, // 44: gitaly.CreateRepositoryFromSnapshotRequest.repository:type_name -> gitaly.Repository
	103, // 45: gitaly.GetRawChangesRequest.repository:type_name -> gitaly.Repository
	99,  // 46: gitaly.GetRawChangesResponse.raw_changes:type_name -> gitaly.GetRawChangesResponse.RawChange
	103, // 47: gitaly.SearchFilesByNameRequest.repository:type_name -> gitaly.Repository
	103, // 48: gitaly.SearchFilesByContentRequest.repository:type_name -> gitaly.Repository
	103, // 49: gitaly.GetObjectDirectorySizeRequest.repository:type_name -> gitaly.Repository
	103, // 50: gitaly.RemoveRepositoryRequest.repository:type_name -> gitaly.Repository
	103, // 51: gitaly.ReplicateRepositoryRequest.repository:type_name -> gitaly.Repository
	103, // 52: gitaly.ReplicateRepositoryRequest.source:type_name -> gitaly.Repository
	103, // 53: gitaly.OptimizeRepositoryRequest.repository:type_name -> gitaly.Repository
	3,   // 54: gitaly.OptimizeRepositoryRequest.strategy:type_name -> gitaly.OptimizeRepositoryRequest.Strategy
	103, // 55: gitaly.PruneUnreachableObjectsRequest.repository:type_name -> gitaly.Repository
	103, // 56: gitaly.BackupRepositoryRequest.repository:type_name -> gitaly.Repository
	103, // 57: gitaly.BackupRepositoryRequest.vanity_repository:type_name -> gitaly.Repository
	103, // 58: gitaly.RestoreRepositoryRequest.repository:type_name -> gitaly.Repository
	103, // 59: gitaly.RestoreRepositoryRequest.vanity_repository:type_name -> gitaly.Repository
	103, // 60: gitaly.GetFileAttributesRequest.repository:type_name -> gitaly.Repository
	102, // 61: gitaly.GetFileAttributesResponse.attribute_infos:type_name -> gitaly.GetFileAttributesResponse.AttributeInfo
	103, // 62: gitaly.FastExportRequest.repository:type_name -> gitaly.Repository
	103, // 63: gitaly.MigrateReferenceBackendRequest.repository:type_name -> gitaly.Repository
	4,   // 64: gitaly.MigrateReferenceBackendRequest.target_reference_backend:type_name -> gitaly.MigrateReferenceBackendRequest.ReferenceBackend
	107, // 65: gitaly.MigrateReferenceBackendResponse.time:type_name -> google.protobuf.Duration
	0,   // 66: gitaly.RepositoryInfoResponse.ReferencesInfo.reference_backend:type_name -> gitaly.RepositoryInfoResponse.ReferencesInfo.ReferenceBackend
	104, // 67: gitaly.RepositoryInfoResponse.AlternatesInfo.last_modified:type_name -> google.protobuf.Timestamp
	2,   // 68: gitaly.GetRawChangesResponse.RawChange.operation:type_name -> gitaly.GetRawChangesResponse.RawChange.Operation
	5,   // 69: gitaly.RepositoryService.RepositoryExists:input_type -> gitaly.RepositoryExistsRequest
	7,   // 70: gitaly.RepositoryService.RepositorySize:input_type -> gitaly.RepositorySizeRequest
	9,   // 71: gitaly.RepositoryService.RepositoryInfo:input_type -> gitaly.RepositoryInfoRequest
	11,  // 72: gitaly.RepositoryService.ObjectsSize:input_type -> gitaly.ObjectsSizeRequest
	13,  // 73: gitaly.RepositoryService.ObjectFormat:input_type -> gitaly.ObjectFormatRequest
	17,  // 74: gitaly.RepositoryService.FetchRemote:input_type -> gitaly.FetchRemoteRequest
	19,  // 75: gitaly.RepositoryService.CreateRepository:input_type -> gitaly.CreateRepositoryRequest
	21,  // 76: gitaly.RepositoryService.GetArchive:input_type -> gitaly.GetArchiveRequest
	23,  // 77: gitaly.RepositoryService.HasLocalBranches:input_type -> gitaly.HasLocalBranchesRequest
	25,  // 78: gitaly.RepositoryService.FetchSourceBranch:input_type -> gitaly.FetchSourceBranchRequest
	27,  // 79: gitaly.RepositoryService.Fsck:input_type -> gitaly.FsckRequest
	29,  // 80: gitaly.RepositoryService.WriteRef:input_type -> gitaly.WriteRefRequest
	31,  // 81: gitaly.RepositoryService.FindMergeBase:input_type -> gitaly.FindMergeBaseRequest
	33,  // 82: gitaly.RepositoryService.CreateFork:input_type -> gitaly.CreateForkRequest
	35,  // 83: gitaly.RepositoryService.CreateRepositoryFromURL:input_type -> gitaly.CreateRepositoryFromURLRequest
	38,  // 84: gitaly.RepositoryService.CreateBundle:input_type -> gitaly.CreateBundleRequest
	40,  // 85: gitaly.RepositoryService.CreateBundleFromRefList:input_type -> gitaly.CreateBundleFromRefListRequest
	42,  // 86: gitaly.RepositoryService.GenerateBundleURI:input_type -> gitaly.GenerateBundleURIRequest
	15,  // 87: gitaly.RepositoryService.FetchBundle:input_type -> gitaly.FetchBundleRequest
	54,  // 88: gitaly.RepositoryService.CreateRepositoryFromBundle:input_type -> gitaly.CreateRepositoryFromBundleRequest
	44,  // 89: gitaly.RepositoryService.GetConfig:input_type -> gitaly.GetConfigRequest
	56,  // 90: gitaly.RepositoryService.FindLicense:input_type -> gitaly.FindLicenseRequest
	58,  // 91: gitaly.RepositoryService.GetInfoAttributes:input_type -> gitaly.GetInfoAttributesRequest
	60,  // 92: gitaly.RepositoryService.CalculateChecksum:input_type -> gitaly.CalculateChecksumRequest
	62,  // 93: gitaly.RepositoryService.GetSnapshot:input_type -> gitaly.GetSnapshotRequest
	64,  // 94: gitaly.RepositoryService.CreateRepositoryFromSnapshot:input_type -> gitaly.CreateRepositoryFromSnapshotRequest
	66,  // 95: gitaly.RepositoryService.GetRawChanges:input_type -> gitaly.GetRawChangesRequest
	70,  // 96: gitaly.RepositoryService.SearchFilesByContent:input_type -> gitaly.SearchFilesByContentRequest
	68,  // 97: gitaly.RepositoryService.SearchFilesByName:input_type -> gitaly.SearchFilesByNameRequest
	46,  // 98: gitaly.RepositoryService.RestoreCustomHooks:input_type -> gitaly.RestoreCustomHooksRequest
	47,  // 99: gitaly.RepositoryService.SetCustomHooks:input_type -> gitaly.SetCustomHooksRequest
	50,  // 100: gitaly.RepositoryService.BackupCustomHooks:input_type -> gitaly.BackupCustomHooksRequest
	51,  // 101: gitaly.RepositoryService.GetCustomHooks:input_type -> gitaly.GetCustomHooksRequest
	73,  // 102: gitaly.RepositoryService.GetObjectDirectorySize:input_type -> gitaly.GetObjectDirectorySizeRequest
	75,  // 103: gitaly.RepositoryService.RemoveRepository:input_type -> gitaly.RemoveRepositoryRequest
	77,  // 104: gitaly.RepositoryService.ReplicateRepository:input_type -> gitaly.ReplicateRepositoryRequest
	79,  // 105: gitaly.RepositoryService.OptimizeRepository:input_type -> gitaly.OptimizeRepositoryRequest
	81,  // 106: gitaly.RepositoryService.PruneUnreachableObjects:input_type -> gitaly.PruneUnreachableObjectsRequest
	83,  // 107: gitaly.RepositoryService.BackupRepository:input_type -> gitaly.BackupRepositoryRequest
	85,  // 108: gitaly.RepositoryService.RestoreRepository:input_type -> gitaly.RestoreRepositoryRequest
	87,  // 109: gitaly.RepositoryService.GetFileAttributes:input_type -> gitaly.GetFileAttributesRequest
	89,  // 110: gitaly.RepositoryService.FastExport:input_type -> gitaly.FastExportRequest
	91,  // 111: gitaly.RepositoryService.MigrateReferenceBackend:input_type -> gitaly.MigrateReferenceBackendRequest
	6,   // 112: gitaly.RepositoryService.RepositoryExists:output_type -> gitaly.RepositoryExistsResponse
	8,   // 113: gitaly.RepositoryService.RepositorySize:output_type -> gitaly.RepositorySizeResponse
	10,  // 114: gitaly.RepositoryService.RepositoryInfo:output_type -> gitaly.RepositoryInfoResponse
	12,  // 115: gitaly.RepositoryService.ObjectsSize:output_type -> gitaly.ObjectsSizeResponse
	14,  // 116: gitaly.RepositoryService.ObjectFormat:output_type -> gitaly.ObjectFormatResponse
	18,  // 117: gitaly.RepositoryService.FetchRemote:output_type -> gitaly.FetchRemoteResponse
	20,  // 118: gitaly.RepositoryService.CreateRepository:output_type -> gitaly.CreateRepositoryResponse
	22,  // 119: gitaly.RepositoryService.GetArchive:output_type -> gitaly.GetArchiveResponse
	24,  // 120: gitaly.RepositoryService.HasLocalBranches:output_type -> gitaly.HasLocalBranchesResponse
	26,  // 121: gitaly.RepositoryService.FetchSourceBranch:output_type -> gitaly.FetchSourceBranchResponse
	28,  // 122: gitaly.RepositoryService.Fsck:output_type -> gitaly.FsckResponse
	30,  // 123: gitaly.RepositoryService.WriteRef:output_type -> gitaly.WriteRefResponse
	32,  // 124: gitaly.RepositoryService.FindMergeBase:output_type -> gitaly.FindMergeBaseResponse
	34,  // 125: gitaly.RepositoryService.CreateFork:output_type -> gitaly.CreateForkResponse
	36,  // 126: gitaly.RepositoryService.CreateRepositoryFromURL:output_type -> gitaly.CreateRepositoryFromURLResponse
	39,  // 127: gitaly.RepositoryService.CreateBundle:output_type -> gitaly.CreateBundleResponse
	41,  // 128: gitaly.RepositoryService.CreateBundleFromRefList:output_type -> gitaly.CreateBundleFromRefListResponse
	43,  // 129: gitaly.RepositoryService.GenerateBundleURI:output_type -> gitaly.GenerateBundleURIResponse
	16,  // 130: gitaly.RepositoryService.FetchBundle:output_type -> gitaly.FetchBundleResponse
	55,  // 131: gitaly.RepositoryService.CreateRepositoryFromBundle:output_type -> gitaly.CreateRepositoryFromBundleResponse
	45,  // 132: gitaly.RepositoryService.GetConfig:output_type -> gitaly.GetConfigResponse
	57,  // 133: gitaly.RepositoryService.FindLicense:output_type -> gitaly.FindLicenseResponse
	59,  // 134: gitaly.RepositoryService.GetInfoAttributes:output_type -> gitaly.GetInfoAttributesResponse
	61,  // 135: gitaly.RepositoryService.CalculateChecksum:output_type -> gitaly.CalculateChecksumResponse
	63,  // 136: gitaly.RepositoryService.GetSnapshot:output_type -> gitaly.GetSnapshotResponse
	65,  // 137: gitaly.RepositoryService.CreateRepositoryFromSnapshot:output_type -> gitaly.CreateRepositoryFromSnapshotResponse
	67,  // 138: gitaly.RepositoryService.GetRawChanges:output_type -> gitaly.GetRawChangesResponse
	71,  // 139: gitaly.RepositoryService.SearchFilesByContent:output_type -> gitaly.SearchFilesByContentResponse
	69,  // 140: gitaly.RepositoryService.SearchFilesByName:output_type -> gitaly.SearchFilesByNameResponse
	48,  // 141: gitaly.RepositoryService.RestoreCustomHooks:output_type -> gitaly.RestoreCustomHooksResponse
	49,  // 142: gitaly.RepositoryService.SetCustomHooks:output_type -> gitaly.SetCustomHooksResponse
	52,  // 143: gitaly.RepositoryService.BackupCustomHooks:output_type -> gitaly.BackupCustomHooksResponse
	53,  // 144: gitaly.RepositoryService.GetCustomHooks:output_type -> gitaly.GetCustomHooksResponse
	74,  // 145: gitaly.RepositoryService.GetObjectDirectorySize:output_type -> gitaly.GetObjectDirectorySizeResponse
	76,  // 146: gitaly.RepositoryService.RemoveRepository:output_type -> gitaly.RemoveRepositoryResponse
	78,  // 147: gitaly.RepositoryService.ReplicateRepository:output_type -> gitaly.ReplicateRepositoryResponse
	80,  // 148: gitaly.RepositoryService.OptimizeRepository:output_type -> gitaly.OptimizeRepositoryResponse
	82,  // 149: gitaly.RepositoryService.PruneUnreachableObjects:output_type -> gitaly.PruneUnreachableObjectsResponse
	84,  // 150: gitaly.RepositoryService.BackupRepository:output_type -> gitaly.BackupRepositoryResponse
	86,  // 151: gitaly.RepositoryService.RestoreRepository:output_type -> gitaly.RestoreRepositoryResponse
	88,  // 152: gitaly.RepositoryService.GetFileAttributes:output_type -> gitaly.GetFileAttributesResponse
	90,  // 153: gitaly.RepositoryService.FastExport:output_type -> gitaly.FastExportResponse
	92,  // 154: gitaly.RepositoryService.MigrateReferenceBackend:output_type -> gitaly.MigrateReferenceBackendResponse
