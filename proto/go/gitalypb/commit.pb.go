...
type CommitLanguagesResponse_Language struct {
	...
	// Value "-1" indicates either the language was not found or the ID exceeds int32 limits
	LanguageId    int32 `protobuf:"varint,6,opt,name=language_id,json=languageId,proto3" json:"language_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CommitLanguagesResponse_Language) GetLanguageId() int32 {
	if x != nil {
		return x.LanguageId
	}
	return 0
...
var file_commit_proto_rawDesc = string([]byte{
	...
	0x05, 0x52, 0x0a, 0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x49, 0x64, 0x4a, 0x04, 0x08,
