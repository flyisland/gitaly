...
func (x *ListCommitsRequest) GetSkip() uint32 {
	if x != nil {
		return x.Skip
	}
	return 0
...
func (x *CommitStatsResponse) GetFiles() int32 {
	if x != nil {
		return x.Files
	}
	return 0
...
func (x *GetTreeEntriesError) GetError() isGetTreeEntriesError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *GetTreeEntriesError) GetResolveTree() *ResolveRevisionError {
	if x != nil {
		if x, ok := x.Error.(*GetTreeEntriesError_ResolveTree); ok {
...
func (x *GetTreeEntriesError) GetPath() *PathError {
	if x != nil {
		if x, ok := x.Error.(*GetTreeEntriesError_Path); ok {
			return x.Path
		}
	}
	return nil
...
type FindCommitsRequest struct {
	...
	MessageRegex  string `protobuf:"bytes,19,opt,name=message_regex,json=messageRegex,proto3" json:"message_regex,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FindCommitsRequest) GetMessageRegex() string {
	if x != nil {
...
func (x *FindCommitsError) GetError() isFindCommitsError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *FindCommitsError) GetBadObject() *BadObjectError {
	if x != nil {
		if x, ok := x.Error.(*FindCommitsError_BadObject); ok {
			return x.BadObject
		}
	}
	return nil
...
func (x *FindCommitsError) GetAmbiguousRef() *AmbiguousReferenceError {
	if x != nil {
		if x, ok := x.Error.(*FindCommitsError_AmbiguousRef); ok {
...
func (x *FindCommitsError) GetInvalidRange() *InvalidRevisionRange {
	if x != nil {
		if x, ok := x.Error.(*FindCommitsError_InvalidRange); ok {
...
type RawBlameRequest struct {
	...
	// call will fail.
	IgnoreRevisionsBlob []byte `protobuf:"bytes,5,opt,name=ignore_revisions_blob,json=ignoreRevisionsBlob,proto3" json:"ignore_revisions_blob,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *RawBlameRequest) GetIgnoreRevisionsBlob() []byte {
	if x != nil {
		return x.IgnoreRevisionsBlob
	}
	return nil
}
...
type RawBlameError struct {
	...
	//	*RawBlameError_ResolveIgnoreRevs
	//	*RawBlameError_InvalidIgnoreRevsFormat
...
func (x *RawBlameError) GetError() isRawBlameError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *RawBlameError) GetPathNotFound() *PathNotFoundError {
	if x != nil {
		if x, ok := x.Error.(*RawBlameError_PathNotFound); ok {
...
func (x *RawBlameError) GetOutOfRange() *RawBlameError_OutOfRangeError {
	if x != nil {
		if x, ok := x.Error.(*RawBlameError_OutOfRange); ok {
			return x.OutOfRange
		}
	}
	return nil
...
func (x *RawBlameError) GetResolveIgnoreRevs() *RawBlameError_ResolveIgnoreRevsError {
	if x != nil {
		if x, ok := x.Error.(*RawBlameError_ResolveIgnoreRevs); ok {
			return x.ResolveIgnoreRevs
		}
	}
	return nil
}

func (x *RawBlameError) GetInvalidIgnoreRevsFormat() *RawBlameError_InvalidIgnoreRevsFormatError {
	if x != nil {
		if x, ok := x.Error.(*RawBlameError_InvalidIgnoreRevsFormat); ok {
			return x.InvalidIgnoreRevsFormat
		}
	}
	return nil
}
...
type RawBlameError_ResolveIgnoreRevs struct {
	// resolve_ignore_revs indicates that resolving the specified file containing
	// ignored revisions has failed.
	ResolveIgnoreRevs *RawBlameError_ResolveIgnoreRevsError `protobuf:"bytes,3,opt,name=resolve_ignore_revs,json=resolveIgnoreRevs,proto3,oneof"`
}

type RawBlameError_InvalidIgnoreRevsFormat struct {
	// invalid_ignore_revs_format indicates that the specified file containing ignored
	// revisions has an invalid format.
	InvalidIgnoreRevsFormat *RawBlameError_InvalidIgnoreRevsFormatError `protobuf:"bytes,4,opt,name=invalid_ignore_revs_format,json=invalidIgnoreRevsFormat,proto3,oneof"`
}
...
func (*RawBlameError_ResolveIgnoreRevs) isRawBlameError_Error() {}

func (*RawBlameError_InvalidIgnoreRevsFormat) isRawBlameError_Error() {}
...
type GetCommitSignaturesResponse struct {
	...
	Author *CommitAuthor `protobuf:"bytes,5,opt,name=author,proto3" json:"author,omitempty"`
	...
	Committer     *CommitAuthor `protobuf:"bytes,6,opt,name=committer,proto3" json:"committer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetCommitSignaturesResponse) GetAuthor() *CommitAuthor {
	if x != nil {
		return x.Author
	}
	return nil
...
func (x *GetCommitSignaturesResponse) GetCommitter() *CommitAuthor {
	if x != nil {
		return x.Committer
	}
	return nil
...
// revisions has an invalid format.
type RawBlameError_InvalidIgnoreRevsFormatError struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *RawBlameError_InvalidIgnoreRevsFormatError) Reset() {
	*x = RawBlameError_InvalidIgnoreRevsFormatError{}
	mi := &file_commit_proto_msgTypes[53]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RawBlameError_InvalidIgnoreRevsFormatError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawBlameError_InvalidIgnoreRevsFormatError) ProtoMessage() {}

func (x *RawBlameError_InvalidIgnoreRevsFormatError) ProtoReflect() protoreflect.Message {
	mi := &file_commit_proto_msgTypes[53]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawBlameError_InvalidIgnoreRevsFormatError.ProtoReflect.Descriptor instead.
func (*RawBlameError_InvalidIgnoreRevsFormatError) Descriptor() ([]byte, []int) {
	return file_commit_proto_rawDescGZIP(), []int{35, 1}
}

func (x *RawBlameError_InvalidIgnoreRevsFormatError) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
type RawBlameError_ResolveIgnoreRevsError struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// ignore_revisions_blob is provided revision that does not refer to a blob
	IgnoreRevisionsBlob []byte `protobuf:"bytes,1,opt,name=ignore_revisions_blob,json=ignoreRevisionsBlob,proto3" json:"ignore_revisions_blob,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}

func (x *RawBlameError_ResolveIgnoreRevsError) Reset() {
	*x = RawBlameError_ResolveIgnoreRevsError{}
	mi := &file_commit_proto_msgTypes[54]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RawBlameError_ResolveIgnoreRevsError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RawBlameError_ResolveIgnoreRevsError) ProtoMessage() {}

func (x *RawBlameError_ResolveIgnoreRevsError) ProtoReflect() protoreflect.Message {
	mi := &file_commit_proto_msgTypes[54]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RawBlameError_ResolveIgnoreRevsError.ProtoReflect.Descriptor instead.
func (*RawBlameError_ResolveIgnoreRevsError) Descriptor() ([]byte, []int) {
	return file_commit_proto_rawDescGZIP(), []int{35, 2}
}

func (x *RawBlameError_ResolveIgnoreRevsError) GetIgnoreRevisionsBlob() []byte {
	if x != nil {
		return x.IgnoreRevisionsBlob
	}
	return nil
...
func (x *CheckObjectsExistResponse_RevisionExistence) Reset() {
	*x = CheckObjectsExistResponse_RevisionExistence{}
	mi := &file_commit_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var file_commit_proto_rawDesc = string([]byte{
	...
	0x81, 0x05, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x52,
	...
	0x50, 0x61, 0x74, 0x74, 0x65, 0x72, 0x6e, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x6b, 0x69, 0x70,
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x04, 0x73, 0x6b, 0x69, 0x70, 0x22, 0x25, 0x0a, 0x05,
	...
	0x45, 0x10, 0x02, 0x22, 0x42, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x22, 0x9b, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74,
	...
	0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x48, 0x0a, 0x11, 0x70,
	0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e,
	0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x65,
	0x74, 0x65, 0x72, 0x52, 0x10, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x50,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x45, 0x0a, 0x16, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x6c, 0x6c,
	...
	0x6d, 0x69, 0x74, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x22, 0x6a, 0x0a, 0x12,
	0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x72, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x79, 0x0a, 0x13, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x64, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x61, 0x64, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12,
	0x1c, 0x0a, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x09, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x14, 0x0a,
	0x05, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x66, 0x69,
	0x6c, 0x65, 0x73, 0x22, 0x8f, 0x01, 0x0a, 0x17, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49, 0x73,
	0x41, 0x6e, 0x63, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x61, 0x6e, 0x63,
	0x65, 0x73, 0x74, 0x6f, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x61, 0x6e, 0x63, 0x65, 0x73, 0x74, 0x6f, 0x72, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x63, 0x68,
	0x69, 0x6c, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x68,
	0x69, 0x6c, 0x64, 0x49, 0x64, 0x22, 0x30, 0x0a, 0x18, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x49,
	...
	0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x22, 0xad, 0x01, 0x0a, 0x10, 0x54, 0x72, 0x65, 0x65,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0a,
	...
	,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x35, 0x0a, 0x0a, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x43, 0x4f, 0x4d, 0x4d, 0x49, 0x54, 0x10, 0x00, 0x12,
	0x08, 0x0a, 0x04, 0x42, 0x4c, 0x4f, 0x42, 0x10, 0x01, 0x12, 0x08, 0x0a, 0x04, 0x54, 0x52, 0x45,
	0x45, 0x10, 0x02, 0x12, 0x07, 0x0a, 0x03, 0x54, 0x41, 0x47, 0x10, 0x03, 0x22, 0xf5, 0x02, 0x0a,
	0x13, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x71,
	...
	0x52, 0x08, 0x72, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x30, 0x0a, 0x05, 0x61, 0x66,
	...
	0x70, 0x61, 0x74, 0x68, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x61, 0x78, 0x5f, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x65, 0x6e, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x66, 0x69, 0x72, 0x73, 0x74,
	0x50, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x12, 0x3c, 0x0a, 0x0e, 0x67, 0x6c, 0x6f, 0x62, 0x61, 0x6c,
	0x5f, 0x6f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x22, 0x2c, 0x0a, 0x14, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x43, 0x6f, 0x6d,
	...
	0x6e, 0x74, 0x22, 0xab, 0x01, 0x0a, 0x1c, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x44, 0x69, 0x76, 0x65,
	0x72, 0x67, 0x69, 0x6e, 0x67, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	,
	...
	0x6d, 0x69, 0x74, 0x73, 0x22, 0xf6, 0x05, 0x0a, 0x12, 0x46, 0x69, 0x6e, 0x64, 0x43, 0x6f, 0x6d,
	...
	0x28, 0x08, 0x52, 0x0a, 0x73, 0x6b, 0x69, 0x70, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x73, 0x12, 0x25,
	0x0a, 0x0c, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x77, 0x61, 0x6c, 0x6b, 0x18, 0x08,
	0x20, 0x01, 0x28, 0x08, 0x42, 0x02, 0x18, 0x01, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x61, 0x62, 0x6c,
	0x65, 0x57, 0x61, 0x6c, 0x6b, 0x12, 0x30, 0x0a, 0x05, 0x61, 0x66, 0x74, 0x65, 0x72, 0x18, 0x09,
	...
	0x61, 0x6d, 0x70, 0x52, 0x06, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x61,
	0x6c, 0x6c, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x61, 0x6c, 0x6c, 0x12, 0x21, 0x0a,
	0x0c, 0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x18, 0x0c, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x0b, 0x66, 0x69, 0x72, 0x73, 0x74, 0x50, 0x61, 0x72, 0x65, 0x6e, 0x74,
	0x12, 0x16, 0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x12, 0x36, 0x0a, 0x05, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x20, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79,
	...
	,
	...
	,
	...
	0x69, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xd5, 0x01, 0x0a, 0x17, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	...
	0x6c, 0x61, 0x6e, 0x67, 0x75, 0x61, 0x67, 0x65, 0x73, 0x1a, 0x72, 0x0a, 0x08, 0x4c, 0x61, 0x6e,
	...
	0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x12, 0x14, 0x0a, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x62, 0x79, 0x74, 0x65, 0x73, 0x4a, 0x04, 0x08, 0x04, 0x10,
	0x05, 0x52, 0x0a, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xc5, 0x01,
	0x0a, 0x0f, 0x52, 0x61, 0x77, 0x42, 0x6c, 0x61, 0x6d, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x38, 0x0a, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x52,
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x42, 0x04, 0x98, 0xc6, 0x2c, 0x01, 0x52,
	...
	,
	...
	0x73, 0x22, 0xe5, 0x02, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x53,
	...
	,
	...
	,
	...
	0x52, 0x06, 0x65, 0x78, 0x69, 0x73, 0x74, 0x73, 0x32, 0xf1, 0x10, 0x0a, 0x0d, 0x43, 0x6f, 0x6d,
	...
	,
	...
	0x02, 0x08, 0x02, 0x12, 0x59, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x54, 0x72, 0x65, 0x65, 0x45, 0x6e,
	0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x1d, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x47,
	0x65, 0x74, 0x54, 0x72, 0x65, 0x65, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65, 0x73, 0x52, 0x65, 0x71,
	...
	0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x12, 0x18, 0x2e, 0x67, 0x69,
	0x74, 0x61, 0x6c, 0x79, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65,
	...
	,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x02,
	0x30, 0x01, 0x12, 0x50, 0x0a, 0x0b, 0x46, 0x69, 0x6e, 0x64, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
	0x73, 0x12, 0x1a, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x46, 0x69, 0x6e, 0x64, 0x43,
	...
	,
	...
	0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x73, 0x42, 0x79, 0x4d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x12, 0x1f, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x43, 0x6f, 0x6d, 0x6d,
	...
	,
	...
	0x18, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x53, 0x68, 0x61, 0x73, 0x57, 0x69, 0x74, 0x68, 0x53,
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x73, 0x12, 0x27, 0x2e, 0x67, 0x69, 0x74, 0x61,
	...
	0x73, 0x74, 0x1a, 0x28, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x46, 0x69, 0x6c, 0x74,
	...
	,
	...
	0x28, 0x02, 0x08, 0x02, 0x30, 0x01, 0x12, 0x64, 0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x4f,
	0x62, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x45, 0x78, 0x69, 0x73, 0x74, 0x12, 0x20, 0x2e, 0x67, 0x69,
	0x74, 0x61, 0x6c, 0x79, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74,
	0x73, 0x45, 0x78, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x21, 0x2e,
...
var file_commit_proto_msgTypes = make([]protoimpl.MessageInfo, 57)
var file_commit_proto_goTypes = []any{
	...
	(*RawBlameError_InvalidIgnoreRevsFormatError)(nil),   // 60: gitaly.RawBlameError.InvalidIgnoreRevsFormatError
	(*RawBlameError_ResolveIgnoreRevsError)(nil),         // 61: gitaly.RawBlameError.ResolveIgnoreRevsError
	(*ListLastCommitsForTreeResponse_CommitForTree)(nil), // 62: gitaly.ListLastCommitsForTreeResponse.CommitForTree
	(*CheckObjectsExistResponse_RevisionExistence)(nil),  // 63: gitaly.CheckObjectsExistResponse.RevisionExistence
	...
	(*GlobalOptions)(nil),                                // 68: gitaly.GlobalOptions
	...
	(*AmbiguousReferenceError)(nil),                      // 73: gitaly.AmbiguousReferenceError
	(*InvalidRevisionRange)(nil),                         // 74: gitaly.InvalidRevisionRange
	(*PathNotFoundError)(nil),                            // 75: gitaly.PathNotFoundError
	(*CommitAuthor)(nil),                                 // 76: gitaly.CommitAuthor
}
var file_commit_proto_depIdxs = []int32{
	64, // 0: gitaly.ListCommitsRequest.repository:type_name -> gitaly.Repository
	65, // 1: gitaly.ListCommitsRequest.pagination_params:type_name -> gitaly.PaginationParameter
	...
	64, // 6: gitaly.ListAllCommitsRequest.repository:type_name -> gitaly.Repository
	65, // 7: gitaly.ListAllCommitsRequest.pagination_params:type_name -> gitaly.PaginationParameter
	67, // 8: gitaly.ListAllCommitsResponse.commits:type_name -> gitaly.GitCommit
	64, // 9: gitaly.CommitStatsRequest.repository:type_name -> gitaly.Repository
	64, // 10: gitaly.CommitIsAncestorRequest.repository:type_name -> gitaly.Repository
	64, // 11: gitaly.TreeEntryRequest.repository:type_name -> gitaly.Repository
	1,  // 12: gitaly.TreeEntryResponse.type:type_name -> gitaly.TreeEntryResponse.ObjectType
	64, // 13: gitaly.CountCommitsRequest.repository:type_name -> gitaly.Repository
	66, // 14: gitaly.CountCommitsRequest.after:type_name -> google.protobuf.Timestamp
	66, // 15: gitaly.CountCommitsRequest.before:type_name -> google.protobuf.Timestamp
	68, // 16: gitaly.CountCommitsRequest.global_options:type_name -> gitaly.GlobalOptions
	64, // 17: gitaly.CountDivergingCommitsRequest.repository:type_name -> gitaly.Repository
	2,  // 18: gitaly.TreeEntry.type:type_name -> gitaly.TreeEntry.EntryType
	64, // 19: gitaly.GetTreeEntriesRequest.repository:type_name -> gitaly.Repository
	3,  // 20: gitaly.GetTreeEntriesRequest.sort:type_name -> gitaly.GetTreeEntriesRequest.SortBy
	65, // 21: gitaly.GetTreeEntriesRequest.pagination_params:type_name -> gitaly.PaginationParameter
	21, // 22: gitaly.GetTreeEntriesResponse.entries:type_name -> gitaly.TreeEntry
	69, // 23: gitaly.GetTreeEntriesResponse.pagination_cursor:type_name -> gitaly.PaginationCursor
	70, // 24: gitaly.GetTreeEntriesError.resolve_tree:type_name -> gitaly.ResolveRevisionError
	71, // 25: gitaly.GetTreeEntriesError.path:type_name -> gitaly.PathError
	64, // 26: gitaly.ListFilesRequest.repository:type_name -> gitaly.Repository
	64, // 27: gitaly.FindCommitRequest.repository:type_name -> gitaly.Repository
	67, // 28: gitaly.FindCommitResponse.commit:type_name -> gitaly.GitCommit
	64, // 29: gitaly.ListCommitsByOidRequest.repository:type_name -> gitaly.Repository
	67, // 30: gitaly.ListCommitsByOidResponse.commits:type_name -> gitaly.GitCommit
	64, // 31: gitaly.ListCommitsByRefNameRequest.repository:type_name -> gitaly.Repository
	57, // 32: gitaly.ListCommitsByRefNameResponse.commit_refs:type_name -> gitaly.ListCommitsByRefNameResponse.CommitForRef
	64, // 33: gitaly.FindAllCommitsRequest.repository:type_name -> gitaly.Repository
	4,  // 34: gitaly.FindAllCommitsRequest.order:type_name -> gitaly.FindAllCommitsRequest.Order
	67, // 35: gitaly.FindAllCommitsResponse.commits:type_name -> gitaly.GitCommit
	64, // 36: gitaly.FindCommitsRequest.repository:type_name -> gitaly.Repository
	66, // 37: gitaly.FindCommitsRequest.after:type_name -> google.protobuf.Timestamp
	66, // 38: gitaly.FindCommitsRequest.before:type_name -> google.protobuf.Timestamp
	5,  // 39: gitaly.FindCommitsRequest.order:type_name -> gitaly.FindCommitsRequest.Order
	68, // 40: gitaly.FindCommitsRequest.global_options:type_name -> gitaly.GlobalOptions
	67, // 41: gitaly.FindCommitsResponse.commits:type_name -> gitaly.GitCommit
	72, // 42: gitaly.FindCommitsError.bad_object:type_name -> gitaly.BadObjectError
	73, // 43: gitaly.FindCommitsError.ambiguous_ref:type_name -> gitaly.AmbiguousReferenceError
	74, // 44: gitaly.FindCommitsError.invalid_range:type_name -> gitaly.InvalidRevisionRange
	64, // 45: gitaly.CommitLanguagesRequest.repository:type_name -> gitaly.Repository
	58, // 46: gitaly.CommitLanguagesResponse.languages:type_name -> gitaly.CommitLanguagesResponse.Language
	64, // 47: gitaly.RawBlameRequest.repository:type_name -> gitaly.Repository
	75, // 48: gitaly.RawBlameError.path_not_found:type_name -> gitaly.PathNotFoundError
	59, // 49: gitaly.RawBlameError.out_of_range:type_name -> gitaly.RawBlameError.OutOfRangeError
	61, // 50: gitaly.RawBlameError.resolve_ignore_revs:type_name -> gitaly.RawBlameError.ResolveIgnoreRevsError
	60, // 51: gitaly.RawBlameError.invalid_ignore_revs_format:type_name -> gitaly.RawBlameError.InvalidIgnoreRevsFormatError
	64, // 52: gitaly.LastCommitForPathRequest.repository:type_name -> gitaly.Repository
	68, // 53: gitaly.LastCommitForPathRequest.global_options:type_name -> gitaly.GlobalOptions
	67, // 54: gitaly.LastCommitForPathResponse.commit:type_name -> gitaly.GitCommit
	64, // 55: gitaly.ListLastCommitsForTreeRequest.repository:type_name -> gitaly.Repository
	68, // 56: gitaly.ListLastCommitsForTreeRequest.global_options:type_name -> gitaly.GlobalOptions
	62, // 57: gitaly.ListLastCommitsForTreeResponse.commits:type_name -> gitaly.ListLastCommitsForTreeResponse.CommitForTree
	64, // 58: gitaly.CommitsByMessageRequest.repository:type_name -> gitaly.Repository
	68, // 59: gitaly.CommitsByMessageRequest.global_options:type_name -> gitaly.GlobalOptions
	67, // 60: gitaly.CommitsByMessageResponse.commits:type_name -> gitaly.GitCommit
	64, // 61: gitaly.FilterShasWithSignaturesRequest.repository:type_name -> gitaly.Repository
	64, // 62: gitaly.GetCommitSignaturesRequest.repository:type_name -> gitaly.Repository
	6,  // 63: gitaly.GetCommitSignaturesResponse.signer:type_name -> gitaly.GetCommitSignaturesResponse.Signer
	76, // 64: gitaly.GetCommitSignaturesResponse.author:type_name -> gitaly.CommitAuthor
	76, // 65: gitaly.GetCommitSignaturesResponse.committer:type_name -> gitaly.CommitAuthor
	64, // 66: gitaly.GetCommitMessagesRequest.repository:type_name -> gitaly.Repository
	64, // 67: gitaly.CheckObjectsExistRequest.repository:type_name -> gitaly.Repository
	63, // 68: gitaly.CheckObjectsExistResponse.revisions:type_name -> gitaly.CheckObjectsExistResponse.RevisionExistence
	67, // 69: gitaly.ListCommitsByRefNameResponse.CommitForRef.commit:type_name -> gitaly.GitCommit
	67, // 70: gitaly.ListLastCommitsForTreeResponse.CommitForTree.commit:type_name -> gitaly.GitCommit
	7,  // 71: gitaly.CommitService.ListCommits:input_type -> gitaly.ListCommitsRequest
	9,  // 72: gitaly.CommitService.ListAllCommits:input_type -> gitaly.ListAllCommitsRequest
	13, // 73: gitaly.CommitService.CommitIsAncestor:input_type -> gitaly.CommitIsAncestorRequest
	15, // 74: gitaly.CommitService.TreeEntry:input_type -> gitaly.TreeEntryRequest
	17, // 75: gitaly.CommitService.CountCommits:input_type -> gitaly.CountCommitsRequest
	19, // 76: gitaly.CommitService.CountDivergingCommits:input_type -> gitaly.CountDivergingCommitsRequest
	22, // 77: gitaly.CommitService.GetTreeEntries:input_type -> gitaly.GetTreeEntriesRequest
	25, // 78: gitaly.CommitService.ListFiles:input_type -> gitaly.ListFilesRequest
	27, // 79: gitaly.CommitService.FindCommit:input_type -> gitaly.FindCommitRequest
	11, // 80: gitaly.CommitService.CommitStats:input_type -> gitaly.CommitStatsRequest
	33, // 81: gitaly.CommitService.FindAllCommits:input_type -> gitaly.FindAllCommitsRequest
	35, // 82: gitaly.CommitService.FindCommits:input_type -> gitaly.FindCommitsRequest
	38, // 83: gitaly.CommitService.CommitLanguages:input_type -> gitaly.CommitLanguagesRequest
	40, // 84: gitaly.CommitService.RawBlame:input_type -> gitaly.RawBlameRequest
	43, // 85: gitaly.CommitService.LastCommitForPath:input_type -> gitaly.LastCommitForPathRequest
	45, // 86: gitaly.CommitService.ListLastCommitsForTree:input_type -> gitaly.ListLastCommitsForTreeRequest
	47, // 87: gitaly.CommitService.CommitsByMessage:input_type -> gitaly.CommitsByMessageRequest
	29, // 88: gitaly.CommitService.ListCommitsByOid:input_type -> gitaly.ListCommitsByOidRequest
	31, // 89: gitaly.CommitService.ListCommitsByRefName:input_type -> gitaly.ListCommitsByRefNameRequest
	49, // 90: gitaly.CommitService.FilterShasWithSignatures:input_type -> gitaly.FilterShasWithSignaturesRequest
	51, // 91: gitaly.CommitService.GetCommitSignatures:input_type -> gitaly.GetCommitSignaturesRequest
	53, // 92: gitaly.CommitService.GetCommitMessages:input_type -> gitaly.GetCommitMessagesRequest
	55, // 93: gitaly.CommitService.CheckObjectsExist:input_type -> gitaly.CheckObjectsExistRequest
	8,  // 94: gitaly.CommitService.ListCommits:output_type -> gitaly.ListCommitsResponse
	10, // 95: gitaly.CommitService.ListAllCommits:output_type -> gitaly.ListAllCommitsResponse
	14, // 96: gitaly.CommitService.CommitIsAncestor:output_type -> gitaly.CommitIsAncestorResponse
	16, // 97: gitaly.CommitService.TreeEntry:output_type -> gitaly.TreeEntryResponse
	18, // 98: gitaly.CommitService.CountCommits:output_type -> gitaly.CountCommitsResponse
	20, // 99: gitaly.CommitService.CountDivergingCommits:output_type -> gitaly.CountDivergingCommitsResponse
	23, // 100: gitaly.CommitService.GetTreeEntries:output_type -> gitaly.GetTreeEntriesResponse
	26, // 101: gitaly.CommitService.ListFiles:output_type -> gitaly.ListFilesResponse
	28, // 102: gitaly.CommitService.FindCommit:output_type -> gitaly.FindCommitResponse
	12, // 103: gitaly.CommitService.CommitStats:output_type -> gitaly.CommitStatsResponse
	34, // 104: gitaly.CommitService.FindAllCommits:output_type -> gitaly.FindAllCommitsResponse
	36, // 105: gitaly.CommitService.FindCommits:output_type -> gitaly.FindCommitsResponse
	39, // 106: gitaly.CommitService.CommitLanguages:output_type -> gitaly.CommitLanguagesResponse
	41, // 107: gitaly.CommitService.RawBlame:output_type -> gitaly.RawBlameResponse
	44, // 108: gitaly.CommitService.LastCommitForPath:output_type -> gitaly.LastCommitForPathResponse
	46, // 109: gitaly.CommitService.ListLastCommitsForTree:output_type -> gitaly.ListLastCommitsForTreeResponse
	48, // 110: gitaly.CommitService.CommitsByMessage:output_type -> gitaly.CommitsByMessageResponse
	30, // 111: gitaly.CommitService.ListCommitsByOid:output_type -> gitaly.ListCommitsByOidResponse
	32, // 112: gitaly.CommitService.ListCommitsByRefName:output_type -> gitaly.ListCommitsByRefNameResponse
	50, // 113: gitaly.CommitService.FilterShasWithSignatures:output_type -> gitaly.FilterShasWithSignaturesResponse
	52, // 114: gitaly.CommitService.GetCommitSignatures:output_type -> gitaly.GetCommitSignaturesResponse
	54, // 115: gitaly.CommitService.GetCommitMessages:output_type -> gitaly.GetCommitMessagesResponse
	56, // 116: gitaly.CommitService.CheckObjectsExist:output_type -> gitaly.CheckObjectsExistResponse
...
func file_commit_proto_init() {
	...
	file_commit_proto_msgTypes[17].OneofWrappers = []any{
		(*GetTreeEntriesError_ResolveTree)(nil),
		(*GetTreeEntriesError_Path)(nil),
	}
	file_commit_proto_msgTypes[30].OneofWrappers = []any{
		(*FindCommitsError_BadObject)(nil),
		(*FindCommitsError_AmbiguousRef)(nil),
		(*FindCommitsError_InvalidRange)(nil),
	}
	file_commit_proto_msgTypes[35].OneofWrappers = []any{
		(*RawBlameError_PathNotFound)(nil),
		(*RawBlameError_OutOfRange)(nil),
		(*RawBlameError_ResolveIgnoreRevs)(nil),
		(*RawBlameError_InvalidIgnoreRevsFormat)(nil),
	}
	type x struct{}
