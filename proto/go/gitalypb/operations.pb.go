...
var file_operations_proto_rawDesc = string([]byte{
	...
	0xaa, 0x01, 0x0a, 0x18, 0x55, 0x73, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75,
	...
	0x61, 0x74, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xc9, 0x0b, 0x0a,
...
var file_operations_proto_depIdxs = []int32{
	...
	52,  // 91: gitaly.UserRebaseConfirmableRequest.Header.repository:type_name -> gitaly.Repository
	53,  // 92: gitaly.UserRebaseConfirmableRequest.Header.user:type_name -> gitaly.User
	52,  // 93: gitaly.UserRebaseConfirmableRequest.Header.remote_repository:type_name -> gitaly.Repository
	58,  // 94: gitaly.UserRebaseConfirmableRequest.Header.timestamp:type_name -> google.protobuf.Timestamp
	52,  // 95: gitaly.UserApplyPatchRequest.Header.repository:type_name -> gitaly.Repository
	53,  // 96: gitaly.UserApplyPatchRequest.Header.user:type_name -> gitaly.User
	58,  // 97: gitaly.UserApplyPatchRequest.Header.timestamp:type_name -> google.protobuf.Timestamp
	2,   // 98: gitaly.OperationService.UserCreateBranch:input_type -> gitaly.UserCreateBranchRequest
	5,   // 99: gitaly.OperationService.UserUpdateBranch:input_type -> gitaly.UserUpdateBranchRequest
	7,   // 100: gitaly.OperationService.UserDeleteBranch:input_type -> gitaly.UserDeleteBranchRequest
	12,  // 101: gitaly.OperationService.UserCreateTag:input_type -> gitaly.UserCreateTagRequest
	10,  // 102: gitaly.OperationService.UserDeleteTag:input_type -> gitaly.UserDeleteTagRequest
	18,  // 103: gitaly.OperationService.UserMergeToRef:input_type -> gitaly.UserMergeToRefRequest
	20,  // 104: gitaly.OperationService.UserRebaseToRef:input_type -> gitaly.UserRebaseToRefRequest
	15,  // 105: gitaly.OperationService.UserMergeBranch:input_type -> gitaly.UserMergeBranchRequest
	24,  // 106: gitaly.OperationService.UserFFBranch:input_type -> gitaly.UserFFBranchRequest
	26,  // 107: gitaly.OperationService.UserCherryPick:input_type -> gitaly.UserCherryPickRequest
	35,  // 108: gitaly.OperationService.UserCommitFiles:input_type -> gitaly.UserCommitFilesRequest
	38,  // 109: gitaly.OperationService.UserRebaseConfirmable:input_type -> gitaly.UserRebaseConfirmableRequest
	29,  // 110: gitaly.OperationService.UserRevert:input_type -> gitaly.UserRevertRequest
	40,  // 111: gitaly.OperationService.UserSquash:input_type -> gitaly.UserSquashRequest
	44,  // 112: gitaly.OperationService.UserApplyPatch:input_type -> gitaly.UserApplyPatchRequest
	47,  // 113: gitaly.OperationService.UserUpdateSubmodule:input_type -> gitaly.UserUpdateSubmoduleRequest
	3,   // 114: gitaly.OperationService.UserCreateBranch:output_type -> gitaly.UserCreateBranchResponse
	6,   // 115: gitaly.OperationService.UserUpdateBranch:output_type -> gitaly.UserUpdateBranchResponse
	8,   // 116: gitaly.OperationService.UserDeleteBranch:output_type -> gitaly.UserDeleteBranchResponse
	13,  // 117: gitaly.OperationService.UserCreateTag:output_type -> gitaly.UserCreateTagResponse
	11,  // 118: gitaly.OperationService.UserDeleteTag:output_type -> gitaly.UserDeleteTagResponse
	19,  // 119: gitaly.OperationService.UserMergeToRef:output_type -> gitaly.UserMergeToRefResponse
	21,  // 120: gitaly.OperationService.UserRebaseToRef:output_type -> gitaly.UserRebaseToRefResponse
	16,  // 121: gitaly.OperationService.UserMergeBranch:output_type -> gitaly.UserMergeBranchResponse
	25,  // 122: gitaly.OperationService.UserFFBranch:output_type -> gitaly.UserFFBranchResponse
	27,  // 123: gitaly.OperationService.UserCherryPick:output_type -> gitaly.UserCherryPickResponse
	36,  // 124: gitaly.OperationService.UserCommitFiles:output_type -> gitaly.UserCommitFilesResponse
	39,  // 125: gitaly.OperationService.UserRebaseConfirmable:output_type -> gitaly.UserRebaseConfirmableResponse
	30,  // 126: gitaly.OperationService.UserRevert:output_type -> gitaly.UserRevertResponse
	41,  // 127: gitaly.OperationService.UserSquash:output_type -> gitaly.UserSquashResponse
	46,  // 128: gitaly.OperationService.UserApplyPatch:output_type -> gitaly.UserApplyPatchResponse
	48,  // 129: gitaly.OperationService.UserUpdateSubmodule:output_type -> gitaly.UserUpdateSubmoduleResponse
