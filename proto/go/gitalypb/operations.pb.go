...
type UserMergeBranchRequest struct {
	...
	// sign signifies whether the commit is to be signed
	Sign          bool `protobuf:"varint,10,opt,name=sign,proto3" json:"sign,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UserMergeBranchRequest) GetSign() bool {
	if x != nil {
		return x.Sign
	}
	return false
...
func (x *UserMergeToRefRequest) GetSign() bool {
	if x != nil {
		return x.Sign
	}
	return false
...
func (x *UserCherryPickRequest) GetSign() bool {
	if x != nil {
		return x.Sign
	}
	return false
...
// UserApplyPatchError is an error returned by the UserApplyPatch RPC in some specific well
// defined error cases.
type UserApplyPatchError struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Error:
	//
	//	*UserApplyPatchError_CustomHook
	Error         isUserApplyPatchError_Error `protobuf_oneof:"error"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UserApplyPatchError) Reset() {
	*x = UserApplyPatchError{}
	mi := &file_operations_proto_msgTypes[43]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserApplyPatchError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserApplyPatchError) ProtoMessage() {}

func (x *UserApplyPatchError) ProtoReflect() protoreflect.Message {
	mi := &file_operations_proto_msgTypes[43]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserApplyPatchError.ProtoReflect.Descriptor instead.
func (*UserApplyPatchError) Descriptor() ([]byte, []int) {
	return file_operations_proto_rawDescGZIP(), []int{43}
}

func (x *UserApplyPatchError) GetError() isUserApplyPatchError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *UserApplyPatchError) GetCustomHook() *CustomHookError {
	if x != nil {
		if x, ok := x.Error.(*UserApplyPatchError_CustomHook); ok {
			return x.CustomHook
		}
	}
	return nil
...
type isUserApplyPatchError_Error interface {
	isUserApplyPatchError_Error()
}

type UserApplyPatchError_CustomHook struct {
	// custom_hook is set if any custom hook which has running as part of this RPC call has returned
	// a non-zero exit code.
	CustomHook *CustomHookError `protobuf:"bytes,1,opt,name=custom_hook,json=customHook,proto3,oneof"`
}

func (*UserApplyPatchError_CustomHook) isUserApplyPatchError_Error() {}
...
// UserUpdateSubmoduleError is a structured error for the UserUpdateSubmodule RPC.
type UserUpdateSubmoduleError struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to Error:
	//
	//	*UserUpdateSubmoduleError_CustomHook
	//	*UserUpdateSubmoduleError_ReferenceUpdate
	//	*UserUpdateSubmoduleError_PathError
	Error         isUserUpdateSubmoduleError_Error `protobuf_oneof:"error"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UserUpdateSubmoduleError) Reset() {
	*x = UserUpdateSubmoduleError{}
	mi := &file_operations_proto_msgTypes[47]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserUpdateSubmoduleError) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserUpdateSubmoduleError) ProtoMessage() {}

func (x *UserUpdateSubmoduleError) ProtoReflect() protoreflect.Message {
	mi := &file_operations_proto_msgTypes[47]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserUpdateSubmoduleError.ProtoReflect.Descriptor instead.
func (*UserUpdateSubmoduleError) Descriptor() ([]byte, []int) {
	return file_operations_proto_rawDescGZIP(), []int{47}
}

func (x *UserUpdateSubmoduleError) GetError() isUserUpdateSubmoduleError_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *UserUpdateSubmoduleError) GetCustomHook() *CustomHookError {
	if x != nil {
		if x, ok := x.Error.(*UserUpdateSubmoduleError_CustomHook); ok {
			return x.CustomHook
		}
	}
	return nil
...
func (x *UserUpdateSubmoduleError) GetReferenceUpdate() *ReferenceUpdateError {
	if x != nil {
		if x, ok := x.Error.(*UserUpdateSubmoduleError_ReferenceUpdate); ok {
			return x.ReferenceUpdate
		}
	}
	return nil
...
func (x *UserUpdateSubmoduleError) GetPathError() *PathError {
	if x != nil {
		if x, ok := x.Error.(*UserUpdateSubmoduleError_PathError); ok {
			return x.PathError
		}
	}
	return nil
...
type isUserUpdateSubmoduleError_Error interface {
	isUserUpdateSubmoduleError_Error()
}

type UserUpdateSubmoduleError_CustomHook struct {
	// custom_hook is set if any custom hook which has running as part of this RPC call has returned
	// a non-zero exit code.
	CustomHook *CustomHookError `protobuf:"bytes,1,opt,name=custom_hook,json=customHook,proto3,oneof"`
}

type UserUpdateSubmoduleError_ReferenceUpdate struct {
	// reference_update is set if the RPC failed because updating the
	// reference to the new object ID has failed (commiting the update).
	ReferenceUpdate *ReferenceUpdateError `protobuf:"bytes,2,opt,name=reference_update,json=referenceUpdate,proto3,oneof"`
}

type UserUpdateSubmoduleError_PathError struct {
	// path_error is set if there was a failure in reading or updatinggl the submodule path
	PathError *PathError `protobuf:"bytes,3,opt,name=path_error,json=pathError,proto3,oneof"`
}

func (*UserUpdateSubmoduleError_CustomHook) isUserUpdateSubmoduleError_Error() {}

func (*UserUpdateSubmoduleError_ReferenceUpdate) isUserUpdateSubmoduleError_Error() {}

func (*UserUpdateSubmoduleError_PathError) isUserUpdateSubmoduleError_Error() {}
...
var file_operations_proto_rawDesc = string([]byte{
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xe9, 0x02, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x4d,
	...
	,
	...
	0x65, 0x52, 0x0c, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4a,
	0x04, 0x08, 0x02, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x04, 0x10, 0x05, 0x52, 0x11, 0x70, 0x72, 0x65,
	0x5f, 0x72, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xaa,
	0x02, 0x0a, 0x14, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x65, 0x72, 0x67, 0x65, 0x42, 0x72, 0x61, 0x6e,
	0x63, 0x68, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	,
	...
	0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65,
	0x72, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x73, 0x68, 0x61, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53, 0x68, 0x61,
	0x12, 0x1a, 0x0a, 0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c,
	0x42, 0x02, 0x18, 0x01, 0x52, 0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04,
	0x73, 0x69, 0x67, 0x6e, 0x22, 0x4e, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x4d, 0x65, 0x72, 0x67,
	...
	,
	...
	0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x12, 0x28,
	0x0a, 0x10, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x6f, 0x6c, 0x64, 0x5f, 0x6f,
	0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74,
	0x65, 0x64, 0x4f, 0x6c, 0x64, 0x4f, 0x69, 0x64, 0x22, 0x86, 0x01, 0x0a, 0x14, 0x55, 0x73, 0x65,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x2a, 0x0a, 0x11, 0x70, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x63,
	0x65, 0x69, 0x76, 0x65, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0f, 0x70, 0x72, 0x65, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x45, 0x72, 0x72, 0x6f,
	0x72, 0x22, 0xb3, 0x04, 0x0a, 0x15, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x65, 0x72, 0x72, 0x79,
	0x50, 0x69, 0x63, 0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x38, 0x0a, 0x0a, 0x72,
	...
	0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x4f,
	0x6c, 0x64, 0x4f, 0x69, 0x64, 0x12, 0x2c, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f,
	...
	0x74, 0x68, 0x6f, 0x72, 0x5f, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x11, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x45, 0x6d,
	0x61, 0x69, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x22, 0xc0, 0x01, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72,
	...
	,
	...
	0x65, 0x64, 0x12, 0x3d, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c,
	...
	0x6b, 0x42, 0x07, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xbd, 0x03, 0x0a, 0x11, 0x55,
	...
	0x5f, 0x6f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x65,
	0x63, 0x74, 0x65, 0x64, 0x4f, 0x6c, 0x64, 0x4f, 0x69, 0x64, 0x22, 0xea, 0x02, 0x0a, 0x12, 0x55,
	...
	,
	...
	,
	...
	0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x73, 0x65, 0x72,
	...
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x73,
	...
	0x6f, 0x61, 0x64, 0x22, 0xb6, 0x04, 0x0a, 0x1c, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d,
	...
	0x73, 0x69, 0x74, 0x6f, 0x72, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67,
	...
	0x74, 0x53, 0x68, 0x61, 0x12, 0x38, 0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d,
	...
	0x0a, 0x10, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74, 0x65, 0x64, 0x5f, 0x6f, 0x6c, 0x64, 0x5f, 0x6f,
	0x69, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x65, 0x78, 0x70, 0x65, 0x63, 0x74,
	0x65, 0x64, 0x4f, 0x6c, 0x64, 0x4f, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x67, 0x6e,
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x22, 0xb6, 0x01, 0x0a,
	0x16, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x46, 0x69, 0x6c, 0x65, 0x73,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65,
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x74, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x48, 0x00, 0x52, 0x0e, 0x72, 0x65, 0x62, 0x61, 0x73,
	0x65, 0x43, 0x6f, 0x6e, 0x66, 0x6c, 0x69, 0x63, 0x74, 0x12, 0x3d, 0x0a, 0x0c, 0x61, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x5f, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x53, 0x68, 0x61, 0x12, 0x16,
	0x0a, 0x06, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06,
	0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x75, 0x62, 0x6d, 0x6f, 0x64,
	0x75, 0x6c, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x09, 0x73, 0x75, 0x62, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x5f, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0d, 0x63, 0x6f,
	0x6d, 0x6d, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x38, 0x0a, 0x09, 0x74,
	...
	0x64, 0x5f, 0x6f, 0x6c, 0x64, 0x5f, 0x6f, 0x69, 0x64, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52,
	...
	0x5f, 0x74, 0x72, 0x65, 0x65, 0x5f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xde, 0x01, 0x0a, 0x18,
	0x55, 0x73, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6d, 0x6f, 0x64,
	0x75, 0x6c, 0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x3a, 0x0a, 0x0b, 0x63, 0x75, 0x73, 0x74,
	0x6f, 0x6d, 0x5f, 0x68, 0x6f, 0x6f, 0x6b, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	...
	0x48, 0x6f, 0x6f, 0x6b, 0x12, 0x49, 0x0a, 0x10, 0x72, 0x65, 0x66, 0x65, 0x72, 0x65, 0x6e, 0x63,
	...
	,
	...
	,
	...
	,
	...
	0x08, 0x01, 0x12, 0x57, 0x0a, 0x0e, 0x55, 0x73, 0x65, 0x72, 0x43, 0x68, 0x65, 0x72, 0x72, 0x79,
	0x50, 0x69, 0x63, 0x6b, 0x12, 0x1d, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x73,
	...
	,
	...
	,
	...
	0x55, 0x73, 0x65, 0x72, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x50, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0xfa, 0x97, 0x28, 0x02, 0x08, 0x01, 0x28, 0x01,
	0x12, 0x66, 0x0a, 0x13, 0x55, 0x73, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75,
	0x62, 0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x12, 0x22, 0x2e, 0x67, 0x69, 0x74, 0x61, 0x6c, 0x79,
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x75, 0x62, 0x6d, 0x6f,
	0x64, 0x75, 0x6c, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x23, 0x2e, 0x67, 0x69,
	0x74, 0x61, 0x6c, 0x79, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53,
...
var file_operations_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_operations_proto_goTypes = []any{
	...
	(*UserApplyPatchError)(nil),                 // 45: gitaly.UserApplyPatchError
	(*UserApplyPatchResponse)(nil),              // 46: gitaly.UserApplyPatchResponse
	(*UserUpdateSubmoduleRequest)(nil),          // 47: gitaly.UserUpdateSubmoduleRequest
	(*UserUpdateSubmoduleResponse)(nil),         // 48: gitaly.UserUpdateSubmoduleResponse
	(*UserUpdateSubmoduleError)(nil),            // 49: gitaly.UserUpdateSubmoduleError
	(*UserRebaseConfirmableRequest_Header)(nil), // 50: gitaly.UserRebaseConfirmableRequest.Header
	(*UserApplyPatchRequest_Header)(nil),        // 51: gitaly.UserApplyPatchRequest.Header
	(*Repository)(nil),                          // 52: gitaly.Repository
	(*User)(nil),                                // 53: gitaly.User
	(*Branch)(nil),                              // 54: gitaly.Branch
	(*CustomHookError)(nil),                     // 55: gitaly.CustomHookError
	(*AccessCheckError)(nil),                    // 56: gitaly.AccessCheckError
	(*ReferenceUpdateError)(nil),                // 57: gitaly.ReferenceUpdateError
	(*timestamppb.Timestamp)(nil),               // 58: google.protobuf.Timestamp
	(*Tag)(nil),                                 // 59: gitaly.Tag
	(*ReferenceExistsError)(nil),                // 60: gitaly.ReferenceExistsError
	(*MergeConflictError)(nil),                  // 61: gitaly.MergeConflictError
	(*GitCommit)(nil),                           // 62: gitaly.GitCommit
	(*NotAncestorError)(nil),                    // 63: gitaly.NotAncestorError
	(*ChangesAlreadyAppliedError)(nil),          // 64: gitaly.ChangesAlreadyAppliedError
	(*IndexError)(nil),                          // 65: gitaly.IndexError
	(*ResolveRevisionError)(nil),                // 66: gitaly.ResolveRevisionError
	(*PathError)(nil),                           // 67: gitaly.PathError
}
var file_operations_proto_depIdxs = []int32{
	52,  // 0: gitaly.UserCreateBranchRequest.repository:type_name -> gitaly.Repository
	53,  // 1: gitaly.UserCreateBranchRequest.user:type_name -> gitaly.User
	54,  // 2: gitaly.UserCreateBranchResponse.branch:type_name -> gitaly.Branch
	55,  // 3: gitaly.UserCreateBranchError.custom_hook:type_name -> gitaly.CustomHookError
	52,  // 4: gitaly.UserUpdateBranchRequest.repository:type_name -> gitaly.Repository
	53,  // 5: gitaly.UserUpdateBranchRequest.user:type_name -> gitaly.User
	52,  // 6: gitaly.UserDeleteBranchRequest.repository:type_name -> gitaly.Repository
	53,  // 7: gitaly.UserDeleteBranchRequest.user:type_name -> gitaly.User
	56,  // 8: gitaly.UserDeleteBranchError.access_check:type_name -> gitaly.AccessCheckError
	57,  // 9: gitaly.UserDeleteBranchError.reference_update:type_name -> gitaly.ReferenceUpdateError
	55,  // 10: gitaly.UserDeleteBranchError.custom_hook:type_name -> gitaly.CustomHookError
	52,  // 11: gitaly.UserDeleteTagRequest.repository:type_name -> gitaly.Repository
	53,  // 12: gitaly.UserDeleteTagRequest.user:type_name -> gitaly.User
	52,  // 13: gitaly.UserCreateTagRequest.repository:type_name -> gitaly.Repository
	53,  // 14: gitaly.UserCreateTagRequest.user:type_name -> gitaly.User
	58,  // 15: gitaly.UserCreateTagRequest.timestamp:type_name -> google.protobuf.Timestamp
	59,  // 16: gitaly.UserCreateTagResponse.tag:type_name -> gitaly.Tag
	56,  // 17: gitaly.UserCreateTagError.access_check:type_name -> gitaly.AccessCheckError
	57,  // 18: gitaly.UserCreateTagError.reference_update:type_name -> gitaly.ReferenceUpdateError
	55,  // 19: gitaly.UserCreateTagError.custom_hook:type_name -> gitaly.CustomHookError
	60,  // 20: gitaly.UserCreateTagError.reference_exists:type_name -> gitaly.ReferenceExistsError
	52,  // 21: gitaly.UserMergeBranchRequest.repository:type_name -> gitaly.Repository
	53,  // 22: gitaly.UserMergeBranchRequest.user:type_name -> gitaly.User
	58,  // 23: gitaly.UserMergeBranchRequest.timestamp:type_name -> google.protobuf.Timestamp
	22,  // 24: gitaly.UserMergeBranchResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	56,  // 25: gitaly.UserMergeBranchError.access_check:type_name -> gitaly.AccessCheckError
	57,  // 26: gitaly.UserMergeBranchError.reference_update:type_name -> gitaly.ReferenceUpdateError
	55,  // 27: gitaly.UserMergeBranchError.custom_hook:type_name -> gitaly.CustomHookError
	61,  // 28: gitaly.UserMergeBranchError.merge_conflict:type_name -> gitaly.MergeConflictError
	52,  // 29: gitaly.UserMergeToRefRequest.repository:type_name -> gitaly.Repository
	53,  // 30: gitaly.UserMergeToRefRequest.user:type_name -> gitaly.User
	58,  // 31: gitaly.UserMergeToRefRequest.timestamp:type_name -> google.protobuf.Timestamp
	52,  // 32: gitaly.UserRebaseToRefRequest.repository:type_name -> gitaly.Repository
	53,  // 33: gitaly.UserRebaseToRefRequest.user:type_name -> gitaly.User
	58,  // 34: gitaly.UserRebaseToRefRequest.timestamp:type_name -> google.protobuf.Timestamp
	55,  // 35: gitaly.UserFFBranchError.custom_hook:type_name -> gitaly.CustomHookError
	57,  // 36: gitaly.UserFFBranchError.reference_update:type_name -> gitaly.ReferenceUpdateError
	52,  // 37: gitaly.UserFFBranchRequest.repository:type_name -> gitaly.Repository
	53,  // 38: gitaly.UserFFBranchRequest.user:type_name -> gitaly.User
	22,  // 39: gitaly.UserFFBranchResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	52,  // 40: gitaly.UserCherryPickRequest.repository:type_name -> gitaly.Repository
	53,  // 41: gitaly.UserCherryPickRequest.user:type_name -> gitaly.User
	62,  // 42: gitaly.UserCherryPickRequest.commit:type_name -> gitaly.GitCommit
	52,  // 43: gitaly.UserCherryPickRequest.start_repository:type_name -> gitaly.Repository
	58,  // 44: gitaly.UserCherryPickRequest.timestamp:type_name -> google.protobuf.Timestamp
	22,  // 45: gitaly.UserCherryPickResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	61,  // 46: gitaly.UserCherryPickError.cherry_pick_conflict:type_name -> gitaly.MergeConflictError
	63,  // 47: gitaly.UserCherryPickError.target_branch_diverged:type_name -> gitaly.NotAncestorError
	64,  // 48: gitaly.UserCherryPickError.changes_already_applied:type_name -> gitaly.ChangesAlreadyAppliedError
	56,  // 49: gitaly.UserCherryPickError.access_check:type_name -> gitaly.AccessCheckError
	52,  // 50: gitaly.UserRevertRequest.repository:type_name -> gitaly.Repository
	53,  // 51: gitaly.UserRevertRequest.user:type_name -> gitaly.User
	62,  // 52: gitaly.UserRevertRequest.commit:type_name -> gitaly.GitCommit
	52,  // 53: gitaly.UserRevertRequest.start_repository:type_name -> gitaly.Repository
	58,  // 54: gitaly.UserRevertRequest.timestamp:type_name -> google.protobuf.Timestamp
	...
	61,  // 57: gitaly.UserRevertError.merge_conflict:type_name -> gitaly.MergeConflictError
	64,  // 58: gitaly.UserRevertError.changes_already_applied:type_name -> gitaly.ChangesAlreadyAppliedError
	55,  // 59: gitaly.UserRevertError.custom_hook:type_name -> gitaly.CustomHookError
	63,  // 60: gitaly.UserRevertError.not_ancestor:type_name -> gitaly.NotAncestorError
	...
	52,  // 63: gitaly.UserCommitFilesRequestHeader.repository:type_name -> gitaly.Repository
	53,  // 64: gitaly.UserCommitFilesRequestHeader.user:type_name -> gitaly.User
	52,  // 65: gitaly.UserCommitFilesRequestHeader.start_repository:type_name -> gitaly.Repository
	58,  // 66: gitaly.UserCommitFilesRequestHeader.timestamp:type_name -> google.protobuf.Timestamp
	...
	56,  // 70: gitaly.UserCommitFilesError.access_check:type_name -> gitaly.AccessCheckError
	65,  // 71: gitaly.UserCommitFilesError.index_update:type_name -> gitaly.IndexError
	55,  // 72: gitaly.UserCommitFilesError.custom_hook:type_name -> gitaly.CustomHookError
	50,  // 73: gitaly.UserRebaseConfirmableRequest.header:type_name -> gitaly.UserRebaseConfirmableRequest.Header
	52,  // 74: gitaly.UserSquashRequest.repository:type_name -> gitaly.Repository
	53,  // 75: gitaly.UserSquashRequest.user:type_name -> gitaly.User
	53,  // 76: gitaly.UserSquashRequest.author:type_name -> gitaly.User
	58,  // 77: gitaly.UserSquashRequest.timestamp:type_name -> google.protobuf.Timestamp
	61,  // 78: gitaly.UserRebaseConfirmableError.rebase_conflict:type_name -> gitaly.MergeConflictError
	56,  // 79: gitaly.UserRebaseConfirmableError.access_check:type_name -> gitaly.AccessCheckError
	66,  // 80: gitaly.UserSquashError.resolve_revision:type_name -> gitaly.ResolveRevisionError
	61,  // 81: gitaly.UserSquashError.rebase_conflict:type_name -> gitaly.MergeConflictError
	51,  // 82: gitaly.UserApplyPatchRequest.header:type_name -> gitaly.UserApplyPatchRequest.Header
	55,  // 83: gitaly.UserApplyPatchError.custom_hook:type_name -> gitaly.CustomHookError
	22,  // 84: gitaly.UserApplyPatchResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	52,  // 85: gitaly.UserUpdateSubmoduleRequest.repository:type_name -> gitaly.Repository
	53,  // 86: gitaly.UserUpdateSubmoduleRequest.user:type_name -> gitaly.User
	58,  // 87: gitaly.UserUpdateSubmoduleRequest.timestamp:type_name -> google.protobuf.Timestamp
	22,  // 88: gitaly.UserUpdateSubmoduleResponse.branch_update:type_name -> gitaly.OperationBranchUpdate
	55,  // 89: gitaly.UserUpdateSubmoduleError.custom_hook:type_name -> gitaly.CustomHookError
	57,  // 90: gitaly.UserUpdateSubmoduleError.reference_update:type_name -> gitaly.ReferenceUpdateError
	67,  // 91: gitaly.UserUpdateSubmoduleError.path_error:type_name -> gitaly.PathError
	52,  // 92: gitaly.UserRebaseConfirmableRequest.Header.repository:type_name -> gitaly.Repository
	53,  // 93: gitaly.UserRebaseConfirmableRequest.Header.user:type_name -> gitaly.User
	52,  // 94: gitaly.UserRebaseConfirmableRequest.Header.remote_repository:type_name -> gitaly.Repository
	58,  // 95: gitaly.UserRebaseConfirmableRequest.Header.timestamp:type_name -> google.protobuf.Timestamp
	52,  // 96: gitaly.UserApplyPatchRequest.Header.repository:type_name -> gitaly.Repository
	53,  // 97: gitaly.UserApplyPatchRequest.Header.user:type_name -> gitaly.User
	58,  // 98: gitaly.UserApplyPatchRequest.Header.timestamp:type_name -> google.protobuf.Timestamp
	2,   // 99: gitaly.OperationService.UserCreateBranch:input_type -> gitaly.UserCreateBranchRequest
	5,   // 100: gitaly.OperationService.UserUpdateBranch:input_type -> gitaly.UserUpdateBranchRequest
	7,   // 101: gitaly.OperationService.UserDeleteBranch:input_type -> gitaly.UserDeleteBranchRequest
	12,  // 102: gitaly.OperationService.UserCreateTag:input_type -> gitaly.UserCreateTagRequest
	10,  // 103: gitaly.OperationService.UserDeleteTag:input_type -> gitaly.UserDeleteTagRequest
	18,  // 104: gitaly.OperationService.UserMergeToRef:input_type -> gitaly.UserMergeToRefRequest
	20,  // 105: gitaly.OperationService.UserRebaseToRef:input_type -> gitaly.UserRebaseToRefRequest
	15,  // 106: gitaly.OperationService.UserMergeBranch:input_type -> gitaly.UserMergeBranchRequest
	24,  // 107: gitaly.OperationService.UserFFBranch:input_type -> gitaly.UserFFBranchRequest
	26,  // 108: gitaly.OperationService.UserCherryPick:input_type -> gitaly.UserCherryPickRequest
	35,  // 109: gitaly.OperationService.UserCommitFiles:input_type -> gitaly.UserCommitFilesRequest
	38,  // 110: gitaly.OperationService.UserRebaseConfirmable:input_type -> gitaly.UserRebaseConfirmableRequest
	29,  // 111: gitaly.OperationService.UserRevert:input_type -> gitaly.UserRevertRequest
	40,  // 112: gitaly.OperationService.UserSquash:input_type -> gitaly.UserSquashRequest
	44,  // 113: gitaly.OperationService.UserApplyPatch:input_type -> gitaly.UserApplyPatchRequest
	47,  // 114: gitaly.OperationService.UserUpdateSubmodule:input_type -> gitaly.UserUpdateSubmoduleRequest
	3,   // 115: gitaly.OperationService.UserCreateBranch:output_type -> gitaly.UserCreateBranchResponse
	6,   // 116: gitaly.OperationService.UserUpdateBranch:output_type -> gitaly.UserUpdateBranchResponse
	8,   // 117: gitaly.OperationService.UserDeleteBranch:output_type -> gitaly.UserDeleteBranchResponse
	13,  // 118: gitaly.OperationService.UserCreateTag:output_type -> gitaly.UserCreateTagResponse
	11,  // 119: gitaly.OperationService.UserDeleteTag:output_type -> gitaly.UserDeleteTagResponse
	19,  // 120: gitaly.OperationService.UserMergeToRef:output_type -> gitaly.UserMergeToRefResponse
	21,  // 121: gitaly.OperationService.UserRebaseToRef:output_type -> gitaly.UserRebaseToRefResponse
	16,  // 122: gitaly.OperationService.UserMergeBranch:output_type -> gitaly.UserMergeBranchResponse
	25,  // 123: gitaly.OperationService.UserFFBranch:output_type -> gitaly.UserFFBranchResponse
	27,  // 124: gitaly.OperationService.UserCherryPick:output_type -> gitaly.UserCherryPickResponse
	36,  // 125: gitaly.OperationService.UserCommitFiles:output_type -> gitaly.UserCommitFilesResponse
	39,  // 126: gitaly.OperationService.UserRebaseConfirmable:output_type -> gitaly.UserRebaseConfirmableResponse
	30,  // 127: gitaly.OperationService.UserRevert:output_type -> gitaly.UserRevertResponse
	41,  // 128: gitaly.OperationService.UserSquash:output_type -> gitaly.UserSquashResponse
	46,  // 129: gitaly.OperationService.UserApplyPatch:output_type -> gitaly.UserApplyPatchResponse
	48,  // 130: gitaly.OperationService.UserUpdateSubmodule:output_type -> gitaly.UserUpdateSubmoduleResponse
...
func file_operations_proto_init() {
	...
	file_operations_proto_msgTypes[43].OneofWrappers = []any{
		(*UserApplyPatchError_CustomHook)(nil),
	}
	file_operations_proto_msgTypes[47].OneofWrappers = []any{
		(*UserUpdateSubmoduleError_CustomHook)(nil),
		(*UserUpdateSubmoduleError_ReferenceUpdate)(nil),
		(*UserUpdateSubmoduleError_PathError)(nil),
	}
	type x struct{}
