...
var file_diff_proto_rawDesc = string([]byte{
	...
	0x64, 0x50, 0x61, 0x74, 0x68, 0x73, 0x52, 0x05, 0x70, 0x61, 0x74, 0x68, 0x73, 0x22, 0xd8, 0x02,
	...
	0x07, 0x6f, 0x6c, 0x64, 0x50, 0x61, 0x74, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x72,
	0x65, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x58,
...
var file_diff_proto_depIdxs = []int32{
	...
	22, // 29: gitaly.DiffBlobsRequest.raw_info:type_name -> gitaly.ChangedPaths
	7,  // 30: gitaly.DiffBlobsResponse.status:type_name -> gitaly.DiffBlobsResponse.Status
	36, // 31: gitaly.FindChangedPathsRequest.Request.tree_request:type_name -> gitaly.FindChangedPathsRequest.Request.TreeRequest
	37, // 32: gitaly.FindChangedPathsRequest.Request.commit_request:type_name -> gitaly.FindChangedPathsRequest.Request.CommitRequest
	8,  // 33: gitaly.DiffService.CommitDiff:input_type -> gitaly.CommitDiffRequest
	10, // 34: gitaly.DiffService.CommitDelta:input_type -> gitaly.CommitDeltaRequest
	13, // 35: gitaly.DiffService.RawDiff:input_type -> gitaly.RawDiffRequest
	15, // 36: gitaly.DiffService.RawPatch:input_type -> gitaly.RawPatchRequest
	17, // 37: gitaly.DiffService.DiffStats:input_type -> gitaly.DiffStatsRequest
	20, // 38: gitaly.DiffService.FindChangedPaths:input_type -> gitaly.FindChangedPathsRequest
	23, // 39: gitaly.DiffService.GetPatchID:input_type -> gitaly.GetPatchIDRequest
	28, // 40: gitaly.DiffService.RawRangeDiff:input_type -> gitaly.RawRangeDiffRequest
	30, // 41: gitaly.DiffService.RangeDiff:input_type -> gitaly.RangeDiffRequest
	32, // 42: gitaly.DiffService.DiffBlobs:input_type -> gitaly.DiffBlobsRequest
	9,  // 43: gitaly.DiffService.CommitDiff:output_type -> gitaly.CommitDiffResponse
	12, // 44: gitaly.DiffService.CommitDelta:output_type -> gitaly.CommitDeltaResponse
	14, // 45: gitaly.DiffService.RawDiff:output_type -> gitaly.RawDiffResponse
	16, // 46: gitaly.DiffService.RawPatch:output_type -> gitaly.RawPatchResponse
	19, // 47: gitaly.DiffService.DiffStats:output_type -> gitaly.DiffStatsResponse
	21, // 48: gitaly.DiffService.FindChangedPaths:output_type -> gitaly.FindChangedPathsResponse
	24, // 49: gitaly.DiffService.GetPatchID:output_type -> gitaly.GetPatchIDResponse
	29, // 50: gitaly.DiffService.RawRangeDiff:output_type -> gitaly.RawRangeDiffResponse
	31, // 51: gitaly.DiffService.RangeDiff:output_type -> gitaly.RangeDiffResponse
	33, // 52: gitaly.DiffService.DiffBlobs:output_type -> gitaly.DiffBlobsResponse
