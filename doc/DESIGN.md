...
![rugged.new timings](img/rugged-new-timings.png)
...
1. GitLab already has [logic so that the application servers know which file/Git server contains what repository](https://docs.gitlab.com/administration/repository_storage_paths/), this eliminates the need for a router.
